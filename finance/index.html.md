...
- **Accounts Receivable**- customer billing inquiries should be sent to our Accounts Receivable mailbox â€ ar@gitlab.com

## Other Pages Related to Accounting and Finance

- [Signature authorization matrix](https://github.com/daijapan/test/tree/master/finance/authorization-matrix/index.html.md)
- [Sales compensation plan](https://github.com/daijapan/test/tree/master/finance/sales-comp-plan/index.html.md)
- [Analytics](https://github.com/daijapan/test/tree/master/finance/analytics/index.html.md)
- [Operating Metrics](https://github.com/daijapan/test/tree/master/finance/operating-metrics/index.html.md)
- [Monthly Budget vs Actuals Review Process](https://github.com/daijapan/test/tree/master/finance/monthly-budget-actuals-review/index.html.md)
- [Stock Options](https://github.com/daijapan/test/tree/master/stock-options/index.html.md)
- [Travel and Expense Guidelines](https://github.com/daijapan/test/tree/master/finance/travel-expense-guidelines/index.html.md)
...
VAT-number of GitLab BV (NL853740343B01/index.html.md).
...
1. People Ops and Finance will share a private Google Sheet with you where you will log your hours for each day in the â€œhoursâ€ column.
1. There is a dropdown in the â€œpay typeâ€ column, with the default being Regular. There are also options for Overtime, Vacation, Sick, and Bereavement. Choose the appropriate pay type for your time.
...
- [Accounting and Finance Policies](https://github.com/daijapan/test/tree/master/finance/accounting-and-finance-policies/index.html.md)
- [Accounting and Finance Procedures](https://github.com/daijapan/test/tree/master/finance/accounting-and-finance-procedures/index.html.md)

### Department Information
- [Department Structure](https://github.com/daijapan/test/tree/master/finance/department-structure/index.html.md)
- [Creating New Departments](https://github.com/daijapan/test/tree/master/finance/creating-new-departments/index.html.md)
