...
### Posting a payment from a â€œbank customerâ€

In Netsuite:
1. Click on the â€+â€ sign.
1. Click on â€œReceive Paymentâ€ under Customers.
...
1. Log in to Stripe.
1. Type in the cardholderâ€™s name in the search field at the top of the screen.
