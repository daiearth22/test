...
Please see People Ops for more information on [making changes in TriNet](https://github.com/daijapan/test/tree/master/people-operations/sop/#making-changes-in-trinet).
...
* H.S.A
  ...
  * Missed ER contribution will not have a catch up (Employee enrolls late…Lumity will only fund ER contribution on the upcoming pay period. Any missed employer contributions will be disregarded/index.html.md)
