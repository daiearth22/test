...
1. Upon receipt of the resignation, the manager will notify the People Operations Business Partner (POBP/index.html.md) by sending a copy of the resignation email/letter. A discussion with the  manager and POBP should also happen if needed to determine what lead up to the resignation.
1. POBP (POBP/index.html.md) will notify the CEO of the resignation via a direct Slack message.
...
1. After People Operations is made aware of the upcoming resignation an acknowledgement letter or email (email only for contractors or GitLab Inc team members/index.html.md) confirming last day, the name of the POBP that will be reaching out to arrange an [exit interview](#exit-interviews/index.html.md) will be sent. An [example email](https://docs.google.com/document/d/1rZvczqEuyyFDAzjheiF4LpcLuvj9fFd6maPOSDwkYpQ/edit/index.html.md) is available to use for this. 
1. If the individual has a statutory holiday allowance, the holiday taken should be confirmed with the manager and team member via email and then filed in BambooHR. Once that has been done an acknowledgement letter can be prepared.  This will depend on the location and employment status of the team member. Examples of these can be found here:
 - [GitLab Ltd (UK/index.html.md) Resignation Acknowledgement](https://docs.google.com/document/d/1zV1qnZmjQaNZ3QUjrLOtod-FbboNCPmYdqCLIAc7aos/edit/index.html.md)
 - [GitLab BV (Netherlands/index.html.md) Resignation Acknowledgement](https://docs.google.com/document/d/1-9hCL2Xs5po4lZ19L2vrcmGxQIYRD-Emyci3F63kt0c/edit/index.html.md)
...
Involuntary termination of any team member is never easy. We've created some guidelines and information to make this process as humane as we can. Beyond the points outlined below, make sure to refer to our guidelines on [underperformance](https://github.com/daijapan/test/tree/master/underperformance/index.html.md), as well as the [offboarding issue](https://gitlab.com/gitlab-com/people-ops/employment/blob/master/.gitlab/issue_templates/offboarding.md/index.html.md).
...
Ideally, the manager and the team member have walked through the guidelines on [underperformance](https://github.com/daijapan/test/tree/master/underperformance/index.html.md) before reaching this point.

1. Manager: Reach out to the appropriate People Operations Business Partner (POBP/index.html.md) for assistance. POBP will ask about what the performance issues have been, how they have been attempted to be addressed, and will then prepare for the termination.
...
1. POBP: With manager and/or CCO determine if a [separation and release of claims agreement](#Separation-and-Release-of-Claims-Agreements/index.html.md) is appropriate. If so, have it prepared prior to the call.
...
1. Manager and POBP: Decide what offboarding actions need to be taken _before_ the call (e.g. revoke admin permissions/index.html.md), or _during_ the call (e.g. revoke Slack and Gmail access/index.html.md), and which ones can wait until later (see the [offboarding issue](https://gitlab.com/gitlab-com/people-ops/employment/blob/master/.gitlab/issue_templates/offboarding.md/index.html.md) for the full list of actions/index.html.md). Do not create the offboarding issue until _after_ the call, since even confidential issues are still visible to anyone in the team.
...
1. POBP: Make sure to communicate the [practical points](#offboarding-points/index.html.md) from the termination memo outlined below.
1. People Ops: Create the [offboarding issue](https://gitlab.com/gitlab-com/people-ops/employment/blob/master/.gitlab/issue_templates/offboarding.md/index.html.md) and complete all relevant tasks.
...
1. People Ops: If applicable, sign the team member up for a [Mentat](https://thementat.com/index.html.md) subscription. Credentials, licenses, and pricing are in the People Ops 1Password vault.  
1. People Ops: If appropriate (default is that it is appropriate/index.html.md), send a [termination memo](#termination-memo/index.html.md).
...
1. Final Pay: "Your final check (or invoice period/index.html.md) is for the pay period of X and includes X days of pay‚Ä.
1. Company Property: ‚ÄúPlease return all property as explained in the handbook, also please delete GitLab‚Äôs email connection from your phone‚Ä.
1. Business Expenses: ‚ÄúPlease create your final expense report to Expensify (for employees/index.html.md), OR, please file any outstanding expenses with your final invoice (for contractors/index.html.md), so these can be reimbursed to you in a timely manner‚Ä.
1. Confidentiality and Non-Disclosure: ‚ÄúWe know you are a professional, please keep in mind the agreement you signed when you were hired‚Ä.
...
1. COBRA: ‚ÄúYour benefits will cease on last day of the month you are eligible for Consolidated Omnibus Budget Reconciliation Act (‚ÄúCOBRA‚Ä/index.html.md), the carrier (TriNet/index.html.md) has been notified and the carrier will send out the paperwork to your home address on file‚Ä.
1. PPACA: "You may also be eligible under the Patient Protection and Affordable Care Act (‚ÄúPPACA‚Ä/index.html.md) for subsidized health care options via the marketplace. If you are interested it is important that you sign up with the market place well before the 15th of the month to have coverage for the following month‚Ä.
1. HIPAA: " Under the Health Insurance Portability and Accountability Act of 1996 (HIPAA/index.html.md), if you need a certificate of credible coverage please download it from your current carrier's online portal or request it from TriNet‚Ä.
1. Unemployment insurance: "It is up to your state's labor agency (in CA: EDD/index.html.md) to decide if you are eligible for unemployment insurance‚Ä.
 * The unemployment team at TriNet can verify the past employment of former team members. Their phone number is (800/index.html.md) 638-0461
1. Please remember to keep TriNet informed: "If you move I want to be sure your W-2 gets to you at the end of the year. You may also contact X at GitLab (provide phone number and email address/index.html.md) with any other questions that you may have" (consider inviting them to contact you at anytime for any reason/index.html.md).

## Sample termination memo

If appropriate (to be determined by conversation with the manager, CEO, and People Ops/index.html.md), use the following [termination memo](https://docs.google.com/document/d/11Uk8p4VJrLnDD5IAtbTwswPUUEnmeEOazS1kJMhOu70/edit?usp=sharing/index.html.md), which is provided here as an openly viewable Google Doc, but of course needs to be personalized and tailored to each individual's situation. As written, it is applicable to US-based employees only.

### Separation and Release of Claims Agreements

If appropriate (currently only in the case of US based employees, and to be determined by conversation with the manager, CEO, and People Ops/index.html.md) prepare a Separation and Release of Claims Agreement following the steps outlined here. All of these steps are done by People Ops unless specified differently.

1. Prepare the [agreement](https://docs.google.com/document/d/17Dim1GC_LV0XF2DRzYNVRFrKlNE80fuXxAjP-jou8Yw/edit?usp=sharing/index.html.md).
...
1. Additional notes:
   ...
   1. You must use language in your exit meeting that is in no way forceful of the ex-team member to sign the agreement. Use phrasing such as ‚Äúif you choose to sign‚Ä; ‚Äúyou have a right to have legal council review this document before you sign‚Ä, etc.

## Departures are unpleasant

As explained briefly in the [offboarding issue](https://gitlab.com/gitlab-com/people-ops/employment/blob/master/.gitlab/issue_templates/offboarding.md/index.html.md), GitLab does not provide any context around why people are leaving when they do. However as mentioned in the [procedures](https://github.com/daijapan/test/tree/master/offboarding/#procedures/index.html.md), for voluntary terminations,  the team member can share their reasons for leaving if they wish. If they choose not to then we
...
with less context (at least to the people in other buildings/index.html.md).  

## Turnover Data

GitLab's [turnover data](https://docs.google.com/a/gitlab.com/spreadsheets/d/1yk_tlu-Qy3j4VbaB8Yt4wMc5Gocxri9cp7F57DVWyYM/edit?usp=sharing/index.html.md) is only viewable internally. This data is updated on a monthly basis by People Operations.

## Offboarding Issue

Before starting an offboarding issue, make sure that the team member's resignation or termination has been discussed and cleared with _at least_ the member of the executive team to whom the team member (in/index.html.md)directly reports.

When it is time for offboarding, [create a new **confidential** issue]https://gitlab.com/gitlab-com/people-ops/employment/issues/new/index.html.md) for former team member using the `offboarding` [template](https://gitlab.com/gitlab-com/people-ops/employment/blob/master/.gitlab/issue_templates/offboarding.md/index.html.md) using the [dropdown](https://docs.gitlab.com/ee/user/project/description_templates.html#using-the-templates/index.html.md), and edit it for applicability to the individual.
Please [update the checklist](https://gitlab.com/gitlab-com/people-ops/employment/edit/master/.gitlab/issue_templates/offboarding.md/index.html.md) as more steps arise.
...
The closest Fedex to you is located on [full street address, city, state, zip code]. Driving or walking directions can be found here: [enter link from ‚Äúmapping home location to the Fedex location‚Äù]
...
To remove someone from Expensify Log in to [Expensify](https://www.expensify.com/signin/index.html.md) and go to "Settings" in the left sidebar. Select the right policy based upon the entity that employs the team member. Select "People" in the left menu. Select the individual's name and click "Remove".
