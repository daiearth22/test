...
1. Edit the page using [MarkDown](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md). You can preview your changes (but links will not work).
