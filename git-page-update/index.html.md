...
- People that have been here longer than 3 months, the [team page](/team/index.html.md) lists people in order of how long they have been here.
- People that have engineer in their title.
- We encourage you to meet someone new by asking someone you don't know for help. You can also ask for help in #questions or #peopleops by posting 'Who can do a video call with me to help me work on the website locally https://github.com/daijapan/test/tree/master/git-page-update/ ?'. If the other options don't work for you please ask your buddy.

## 2. Start using GitLab

1. Here's where you can find step-by-step guides on the [basics of working with Git and GitLab](https://docs.gitlab.com/ee/gitlab-basics/README.html/index.html.md). You'll need those later.
1. Create your [SSH Keys](https://docs.gitlab.com/ee/gitlab-basics/create-your-ssh-keys.html/index.html.md).
1. For more information about using Git and GitLab see [GitLab University](https://docs.gitlab.com/ee/university/index.html.md).

## 3. Install Git

1. Open a terminal.
1. Check your Git version by executing: `git --version`.
1. If Git is not installed, you should be prompted to install it. Follow this [guide](https://docs.gitlab.com/ee/gitlab-basics/start-using-git.html/index.html.md) to installing Git and
linking your account to Git.

## 4. Install RVM

1. Visit [https://rvm.io](https://rvm.io/index.html.md).
...
1. In a terminal, execute: `rvm install 2.4.4` to install Ruby
   (enter your system password if prompted/index.html.md).
...
1. Visit [http://localhost:4567/](http://localhost:4567/index.html.md) in your browser.
1. You will need to install a text editor to edit the site locally. We recommend
   [Sublime Text 3](http://www.sublimetext.com/3/index.html.md) or [Atom](https://atom.io/index.html.md). Use command / ctrl P to quickly open the file you need.
...
1. Install the [check-my-links](https://chrome.google.com/webstore/detail/check-my-links/ojkcdipcgfaekbeaelaapakgnjflfglf/index.html.md) extension in Chrome (no other browsers
   support unfortunately/index.html.md).
1. Open the page you wish to preview (see previous step/index.html.md).
...
All internal links (links leading to other parts of the website/index.html.md) should be relative.

## 10. Start contributing

Most pages that you might want to edit are written in markdown [Kramdown](http://kramdown.gettalong.org/index.html.md).
Read through our [Markdown Guide](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md) to understand its syntax and create new content.

Instructions on how to update the website are in the
[readme of www-gitlab-com](https://gitlab.com/gitlab-com/www-gitlab-com/blob/master/README.md/index.html.md).

## 11. Add yourself to the Team Page

We are happy to have you join our company and to include you in our [team page](/team/index.html.md). Please follow the instructions and links below that will guide you through each step. There are instructions for both the web interface and locally, depending on your familiarity with git. Feel free to ask anyone at the company questions along the way.

### Add on GitLab.com (Web IDE/index.html.md)

  1. You should have received an invitation to the [www-gitLab-com project](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md) at your GitLab email account. After creating your account, take note of your username and password, because you will need them throughout these steps.
  2.  Find the picture that you'd like to add to our team page, change the picture's name to the following format: `yournameinlowercase.jpg` or `yournameinlowercase.png`. (There should be no space between first and last names e.g. firstlast.jpg or firstlast.png/index.html.md) Ensure the picture size is around 400x400 (*it must be square*/index.html.md) and the format is JPEG or PNG. You can resize your picture using a photo editor like [GIMP](http://www.gimp.org/index.html.md) (cross-platform/index.html.md) or online by searching for "image resize". Any picture that you provide will be made black-and-white automatically after you add it to the team page.
  3. Go to the [GitLab.com / www-gitlab-com](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md) project.
  ...
  12. Enter your Twitter and GitLab handle (without starting with an @/index.html.md) and write a story about yourself. Don't forget you can use other team members' information as a reference and to respect the spaces between lines. Please don't use "tab" because it will break the page format.
  ...
  16. Fill out the merge request details and assign it to People Ops for review (the recommended assignee would be the Talent Operations Specialist who helped you with onboarding/index.html.md).

### Add on GitLab.com (web interface/index.html.md)

  1. You should have received an invitation to the [www-gitLab-com project](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md) at your GitLab email account. After creating your account, take note of your username and password, because you will need them throughout these steps.
  2.  Find the picture that you'd like to add to our team page, change the picture's name to the following format: `yournameinlowercase.jpg` or `yournameinlowercase.png`. (There should be no space between first and last names e.g. firstlast.jpg or firstlast.png/index.html.md) Ensure the picture size is around 400x400 (*it must be square*/index.html.md) and the format is JPEG or PNG. You can resize your picture using a photo editor like [GIMP](http://www.gimp.org/index.html.md) (cross-platform/index.html.md) or online by searching for "image resize". Any picture that you provide will be made black-and-white automatically after you add it to the team page.
  3. In [GitLab.com](https://gitlab.com/index.html.md), select the GitLab.com/www-gitlab-com project.
  4. Click on "Files" (under "Repository" on the left-hand side menu/index.html.md).
  ...
  8. [Create a merge request](https://docs.gitlab.com/ee/gitlab-basics/add-merge-request.html/index.html.md) in [GitLab.com](https://gitlab.com/index.html.md) with the branch that you created with your picture.
  9. Go back to the GitLab.com project. Find the branch dropdown menu at the top of your screen (default value is "master"/index.html.md) and find the branch that you previously created to add your picture (they are in alphabetical order/index.html.md).
  ...
  12. Your information should already be added towards the bottom of this file. You can use `cmd + F` to search the page for your name or initials if you are new. If it’s not, copy the last employee’s markdown text and paste it immediately after their bio to create a new bio. Update the initials to be your `Firstname 'Nickname' Lastname`. Verify that your title is entered correctly. Add the filename of the picture that you uploaded previously, and be sure to remove the "../" before the name of the file. Enter your Twitter and GitLab handle (without starting with an @/index.html.md). Write a story about yourself. Don't forget to use other team members' information as a reference and to respect the spaces between lines. Please don't use "tab" because it will break the page format.
  13. After you added your information, add a comment to your commit and click on “Commit Changes�.
  14. Go to the Merge Request that you previously created with the branch that you are using. Assign it to People Ops for review (the recommended assignee would be the Talent Operations Specialist who helped you with onboarding/index.html.md).

### Add Locally (using the terminal/index.html.md)

  1. You should have received an invitation to the [www-gitLab-com project](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md) at your GitLab email account. After creating your account, take note of your username and password, because you will need them throughout these steps.
  2. Download Git, following the [start using git documentation](https://docs.gitlab.com/ee/gitlab-basics/start-using-git.html/index.html.md). Don't forget to add your Git username and to set your email.
  3. Follow the steps to create and add your [SSH keys](https://docs.gitlab.com/ee/gitlab-basics/create-your-ssh-keys.html/index.html.md). Note: in some of these steps, your [shell](https://docs.gitlab.com/ee/gitlab-basics/start-using-git.html/index.html.md) will require you to add your GitLab.com username and password.
  4. Clone the www-gitlab-com project through your shell, following the [command line commands documentation](https://docs.gitlab.com/ee/gitlab-basics/command-line-commands.html/index.html.md).
  5. Create and checkout a new branch for the changes you will be making.
  6. Find the picture that you’d like to add to our team page, change the picture's name to the following format: `yournameinlowercase.jpg` or `yournameinlowercase.png` (There should be no space between first and last names e.g. firstlast.jpg or firstlast.png/index.html.md) and then add it to the `source/images/team/` directory. Follow the "[how to add an image](https://docs.gitlab.com/ee/gitlab-basics/add-image.html/index.html.md)" steps. Ensure the picture size is around 400x400 (it must be square/index.html.md) and the format is JPEG or PNG. You can resize your picture using a photo editor like [GIMP](http://www.gimp.org/index.html.md) (cross-platform/index.html.md) or online by searching for "image resize". Any picture that you provide will be made black-and-white automatically after you add it to the team page.
  ...
  13. [Create a Merge Request](https://docs.gitlab.com/ee/gitlab-basics/add-merge-request.html/index.html.md) in [GitLab.com](https://gitlab.com/index.html.md) with the branch that you created. Assign it to People Ops for review (the recommended assignee would be the Talent Operations Specialist who helped you with onboarding/index.html.md).

### Add your pet(s/index.html.md) to the Team Pets Page

  Using what you learned in the [steps above](git-pages-update/#11-add-yourself-to-the-team-page/index.html.md), consider adding your pet to the [Team Pets page](https://about.gitlab.com/team-pets/index.html.md). You can follow these instructions for adding them via the Web IDE.

  1. Again, find the picture that you'd like to add to the team pets page, and update the picture's name to the following format: `petname.jpg` or `petname.png`. Ensure the picture size is around 400x400 (*it must be square*/index.html.md).
  1. Go to the [GitLab.com / www-gitlab-com](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md) project.
  ...
  1. Add your pet by following the format of the existing pets on the page (you can copy and paste their lines of code, even/index.html.md). Ensure that you include your pet's name, your name, and the image you uploaded in step 1.
  ...
  1. Fill out the merge request details and assign it to People Ops for review (the recommended assignee would be the Talent Operations Specialist who helped you with onboarding/index.html.md).

## 12. Edit the Handbook

### WebIDE, using the browser
The Web Integrated Development Environment (IDE/index.html.md) is used to make changes within the browser. This method requires no setup.
...
1. Edit the page using [MarkDown](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md). You can preview your changes (but links will not work/index.html.md).
...
1. Submit and you will be taken to the merge request (MR/index.html.md) page.
...
1. Assign the MR to the Handbook Content Manager (or as instructed/index.html.md) for general handbook changes. If the content changes are specific to your team, assign the MR to your manager.

### Locally, using the terminal

  1. If you haven't already, follow steps 1-5 in the "Add yourself to the Team Page"'s "Add Locally (using the terminal/index.html.md)" section above.  (This step is necessary as the handbook lives in the same repository as the rest of GitLab.com/index.html.md).  If you're following this guide in order and have already added yourself to the team page, instead go back to the main branch (via `git checkout master`/index.html.md) and there create a new branch for your handbook edits.
  2. The handbook lives under `sourcehttps://github.com/daijapan/test/tree/master`.  For the most part, you can locate the specific item to edit via that item's URL.  For instance, this page is https://github.com/daijapan/test/tree/master/git-page-update/ and its source lives in `sourcehttps://github.com/daijapan/test/tree/master/git-page-update/index.html.md`.
  ...
  6. As above, [Create a Merge Request](https://docs.gitlab.com/ee/gitlab-basics/add-merge-request.html/index.html.md) in the [www-gitlab-com project](https://gitlab.com/gitlab-com/www-gitlab-com/index.html.md).  If you're onboarding, don't forget to assign it to your manager.
