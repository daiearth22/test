...
1. Use **Full-Disk Encryption** on your work computer and phone. Mac users may<a name="encrypt-home-folder"></a>
   use [FileVault] (for details, refer to [Apple Support](https://support.apple.com/en-in/HT204837/index.html.md))
...
1. For backups on macOS (OSX) follow this tutorial: [How to use Time Machine](https://support.apple.com/en-us/HT201250/index.html.md)
...
1. Do not install software with many known security vulnerabilities (as
  [listed in the handbook](https://github.com/daijapan/test/tree/master/tools-and-tips/#do-not-use)). When in doubt,
...
![Vault Selector](https://github.com/daijapan/test/tree/master/security/1password-vault-selector.png)
...
![Mailchimp Login](https://github.com/daijapan/test/tree/master/security/1password-login.gif)
...
![Vault switching](https://github.com/daijapan/test/tree/master/security/1password-vault-change.gif)
...
![Save login](https://github.com/daijapan/test/tree/master/security/1password-save-login.png)
...
1. Click 3 dots icon
   ![3 little dots](https://github.com/daijapan/test/tree/master/security/1password-totp.png)
...
> ![Teams Login](https://github.com/daijapan/test/tree/master/security/1password-teams-login.png)
