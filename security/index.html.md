...
- [Security Team handbook](https://github.com/daijapan/test/tree/master/engineering/security/index.html.md)
...
1. Set up [1Password] as your password manager and set a **strong and unique**
   ...
   - Post a message in #PeopleOps if you forget your Master Password.
   ...
   - Do not let your password manager store the **master password**. It is okay to
      store the login.
   - For more information, review the [Getting Started guide](https://support.1password.com/explore/team-member/index.html.md)
   and view [this video](https://youtu.be/2cFWk0sBgyM/index.html.md) that guides you through the sign-up process.
   - For account administrators, review the [admin guide](https://support.1password.com/explore/teams-admin/index.html.md).
...
1. You can also consider using a [Yubikey](/2016/06/22/gitlab-adds-support-for-u2f/index.html.md) with GitLab.
1. Use **Full-Disk Encryption** on your work computer and phone. Mac users may<a name="encrypt-home-folder"></a>
   ...
   on the matter in [this article](https://theintercept.com/2015/04/27/encrypting-laptop-like-mean/index.html.md).
...
[security issue tracker](https://gitlab.com/gitlab-com/security/issues/index.html.md)
...
[Security Team](https://github.com/daijapan/test/tree/master/engineering/security/index.html.md), and follow the steps outlined on
...
1. Do not install software with many known security vulnerabilities (as
  [listed in the handbook](https://github.com/daijapan/test/tree/master/tools-and-tips/#do-not-use/index.html.md)/index.html.md). When in doubt,
...
![Vault Selector](https://github.com/daijapan/test/tree/master/security/1password-vault-selector.png/index.html.md)
...
![Mailchimp Login](https://github.com/daijapan/test/tree/master/security/1password-login.gif/index.html.md)
...
![Vault switching](https://github.com/daijapan/test/tree/master/security/1password-vault-change.gif/index.html.md)
...
![Save login](https://github.com/daijapan/test/tree/master/security/1password-save-login.png/index.html.md)
...
1. Click 3 dots icon
   ![3 little dots](https://github.com/daijapan/test/tree/master/security/1password-totp.png/index.html.md)
...
Please refer to demo video [1password TOPT setup](https://support.1password.com/one-time-passwords/index.html.md)
...
> ![Teams Login](https://github.com/daijapan/test/tree/master/security/1password-teams-login.png/index.html.md)
...
sure to [enable Travel Mode](https://support.1password.com/travel-mode/index.html.md) in 1Password. Travel Mode removes copies of any
