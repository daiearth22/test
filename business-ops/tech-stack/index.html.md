...
## Carta
Stock option administration, capitalization table and equity management are all managed using the [Carta](https://carta.com/index.html.md) software platform.
...
[CloudExtend: Google Drive for NetSuite](https://www.celigo.com/products/netsuite-google-apps/index.html.md) is an integration application that connects the Finance team's G-Drive to NetSuite. A few benefits include streamlined Accounts Payable processing, centralization of document storage, and an improved audit trail.


## Cookiebot   
[Cookiebot](https://www.cookiebot.com/en/index.html.md) is a cookie and online tracking consent solution that complies with the consent and information requirements of the EU ePrivacy Directive 2009/136/EC and the General Data Protection Regulation (GDPR/index.html.md). Cookiebot is a self-serve cloud service provided to you by the ePrivacy company Cybot.
...
![](sourcehttps://github.com/daijapan/test/tree/master/business-ops/tech-stack/DiscoverOrg-SFDC-homepage.png/index.html.md)


## DoGood

We are using [DoGood](http://www.mydogood.com/index.html.md) to help set meetings for account executives with leadership in target companies.
...
[Google Analytics](https://www.google.com/analytics/index.html.md) captures all the analytics for GitLab pages outside of the actual app on https://gitlab.com. If you need access to Google Analytics, you can request access from the [Online Marketing Manager](/job-families/marketing/online-growth-manager/index.html.md) or [Marketing Operations Manager](/job-families/marketing/marketing-operations-manager/index.html.md).    


## Google Tag Manager

[Google Tag Manager](https://www.google.com/analytics/tag-manager/index.html.md) is used to manage the firing of the different JavaScript tags we deploy on our website. All marketing tags should be deployed through Google Tag Manager except in cases such as A/B testing software. If you need access to Google Tag Manager, you can request access from the [Online Marketing Manager](/job-families/marketing/online-growth-manager/index.html.md) or [Marketing Operations Manager](/job-families/marketing/marketing-operations-manager/index.html.md).
...
**LeanData from the Account Page**
 ![](sourcehttps://github.com/daijapan/test/tree/master/business-ops/tech-stack/leandata-contact.png/index.html.md)
...
**LeanData from the Lead Page**
 ![](sourcehttps://github.com/daijapan/test/tree/master/business-ops/tech-stack/leandata-lead.png/index.html.md)
...
## Looker
Looker is our primary analytics and visualization tool. Everyone in the company has view-only access to Looker. To request your account, make an issue in the [Looker project](https://gitlab.com/meltano/looker/index.html.md) using the "Looker Access" template.
...
### External Resources
* [Outreach University](http://university.outreach.io/index.html.md)
...
#### Opportunity   
An opportunity is created when a prospect has expressed interest in GitLab. The opportunity record includes information regarding close dates, contract value, and type. An opportunity will be in a certain stage, depending on where it is in the sales cycle. For more information on stages, [click here](https://github.com/daijapan/test/tree/master/sales/#opportunity-stages/index.html.md).
...
### External Resources
* [Salesforce Success Community](https://success.salesforce.com/index.html.md)
...
## OwnBackup
[OwnBackup](https://www.ownbackup.com/index.html.md) is a SalesForce backup tool. We use it to take backups of both data and metadata nightly for the production instance of Salesforce. 
...
## Screaming Frog
[Screaming Frog](https://www.screamingfrog.co.uk/seo-spider/index.html.md) is a desktop web crawler we use to identify, track, and address crawl issues on our website.
...
## Stripe
[Stripe](https://stripe.com/index.html.md) is a software application that enables GitLab customers to make online payments. Finance uses this system to collect information pertaining to payments made online.
...
## Unbounce
[Unbounce](http://unbounce.com/index.html.md) is for the creation of landing pages. The login information is in the marketing vault of 1Password. Currently, we use Unbounce to manage and create pages for our PPC traffic, webcasts, live/VIP events and any gated content (whitepapers, cheat sheets, etc./index.html.md).  
...
##  Zendesk   
Customer support tickets are managed through Zendesk and can be visible in the Lead, Account, or Opportunity object in Salesforce in the form of a Visualforce page. This provides visibility for non-Zendesk users into the support tickets created by their prospects and customers. For more information on this tool, you can visit the Support page [here](https://github.com/daijapan/test/tree/master/support/index.html.md).
