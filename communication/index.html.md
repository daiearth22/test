...
1. Because we work globally, you may receive chat mentions at any time of day. Please consider enabling [Slack's Do not disturb functionality](https://github.com/daijapan/test/tree/master/tools-and-tips/#do-not-disturb-hours) so you don't get interrupted, for example, in your evenings.
...
1. After the general announcements, attendees share their personal interests by adding their name to the schedule or by discussing in a mixer call. The schedule is as follows:
  * Monday: Any topic
  * Tuesday: [Mixer Calls](https://github.com/daijapan/test/tree/master/communication/#mixer-calls), where we split off into smaller groups to discuss what we have been up to. No need to add yourself to the agenda on this day.
  ...
  * Thursday: [Mixer Calls](https://github.com/daijapan/test/tree/master/communication/#mixer-calls), where we split off into smaller groups to discuss what we have been up to. No need to add yourself to the agenda on this day.
  * Friday: Any topic
...
1. For meetings that are scheduled with Zoom:
   ...
   1. If you need more privileges on Zoom (longer meeting times, more people in the meeting, etc.), please contact People Ops as described [specifically for Zoom](https://github.com/daijapan/test/tree/master/tools-and-tips/#sts=Zoom).
...
![Google Calendar - make calendar available setting](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-calendar-share.png)
...
If you need to provide the details of GitLab's contact information you can take the [address from the visiting page](/visiting) for reference; or the [mailing address](https://github.com/daijapan/test/tree/master/people-operations/#addresses) of the office in the Netherlands if that is more applicable.
...
Make sure that domains don't overlap, for example [organization size](https://github.com/daijapan/test/tree/master/sales/#organization-size) and [deal size](https://github.com/daijapan/test/tree/master/sales/#deal-sizes) don't reuse words to prevent overlap.
If a term is ambiguous don't use it, for example our [hiring definitons](https://github.com/daijapan/test/tree/master/hiring/#definitions) have roles and vacancies but avoid the ambiguous word job.
Make sure that people can infer as much as possible from the word, for example our [subscription options](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#tiers) allow you to know if someone if using self-managed or GitLab.com.
Make sure terms don't overlap without clearly defining how and why, for example see our [tier definitions](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#definitions).
...
1. If you have a conversation that might be interesting please hit "record" (unless the [meeting is being livestreamed](https://github.com/daijapan/test/tree/master/communication/#live-streaming/index.html.md) already).
1. Log in to the [Zoom](https://zoom.us/) account of the meeting and go to the menu on the right and choose "My Recordings" (it can take up to 30 minutes before the recording is available to be shared/index.html.md).
...
1. Go to the [YouTube upload page](https://www.youtube.com/upload/index.html.md) and log in to the GitLab account (read the secure note in 1Password called "YouTube" for instructions on how to get access).
