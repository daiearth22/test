...
### Initiative: Adoption
Ensuring paying customers are successful in their onboarding in order to gain adoption and get the most out of our platform and remain happy, paying GitLabbers and brand advocates.
...
* [Solutions Architects handbook](https://github.com/daijapan/test/tree/master/customer-success/solutions-architects/index.html.md)

### Implementation Engineers
* [Implementation Engineering handbook](https://github.com/daijapan/test/tree/master/customer-success/implementation-engineering/index.html.md)

### Technical Account Managers
* [Technical Account Manager handbook](https://github.com/daijapan/test/tree/master/customer-success/tam/index.html.md)

### Account Managers
* [Account Managers handbook](https://github.com/daijapan/test/tree/master/customer-success/account-management/index.html.md)
...
|  **12** | Create and submit professional services implementation SOW to stakeholders | Implementation engineer | Opportunity | Proposal | Statement of Work (inclusive of blueprint solution design/index.html.md) |
|  **13** | Create and submit Proof of Value (PoV/PoC) plan to stakeholders  | Solution Architect | Opportunity | Technical Evaluation | PoV plan (inclusive of blueprint solution design/index.html.md) |
...
|  **15** | Create and complete [Customer Success Plan](https://github.com/daijapan/test/tree/master/customer-success/tam/#managing-the-customer-engagement) | Solutions Architect | Opportunity | Negotiating |
...
This will sometimes be cross-referenced with a data & analytics project that is located [here](https://gitlab.com/meltano/looker/issues).
...
* [Sales Operations](https://github.com/daijapan/test/tree/master/sales/salesops/)
...
For definitions of the account size, refer to [market segmentation](https://github.com/daijapan/test/tree/master/sales#market-segmentation) which is based on the _Potential EE Users_ field on the account.
