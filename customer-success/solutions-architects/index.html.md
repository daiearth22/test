...
1) Navigate to the [SA Service Desk Board](https://gitlab.com/gitlab-com/customer-success/sa-service-desk/boards/339477/index.html.md)
...
Each week, a Solutions Architect is assigned as the 'Triage SA' for the week.  This is indicated both in the `SA Triaged` label _(e.g. SA Triaged - Feb 12-16 - @dt)_ as well as in the [#customer-success](https://gitlab.slack.com/messages/C5D346V08/index.html.md) channel in Slack.
...
The call is on Tuesday and Thursday at 12:30 pm EST (9:30 am PST). Anyone at GitLab is welcome to join these calls via [Zoom](https://gitlab.zoom.us/j/851100730/index.html.md)
