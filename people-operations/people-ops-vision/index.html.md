...
1. Default to [transparency](https://github.com/daijapan/test/tree/master/values/#sts=Transparency/index.html.md). Only make something confidential if it is explicitly so.
...
1. Have [plenty of guest speakers and cover broad subjects](http://tomtunguz.com/continuing-education-picasso/index.html.md)
