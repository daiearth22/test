...
* Fax: (215/index.html.md) 689-3885 (must include company name with report)
...
Team members will review and sign the [Code of Business Conduct & Ethics Acknowledgment Form](https://docs.google.com/document/d/1ehxrg-ieUEx1ARZv4LpysMfxzFmnhgtzmJn1-299g_E/edit?usp=sharing) during onboarding as well as annually during the [Global Compensation Annual Review](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#annual-compensation-review) cycle.
...
- Employees of GitLab Inc. who receive a pay stub from TriNet will see sick time accrue on their pay stub at the rate of 0.0346 hrs per hour worked (3 hours of sick leave per semi-monthly pay-period) for a maximum accrual and carry-over of 72 hours per year. GitLab's policy is more generous than this, in the sense that you can take off non-accrued sick time as written above (a negative balance may show on your pay stub). Sick time does not get paid out in case of termination, nor does it reduce your final paycheck in case of a negative balance. Related to the topic of extended leave requests, see information about [short term disability](https://github.com/daijapan/test/tree/master/benefits/#std-ltd) through TriNet / your state.
- Employees of GitLab B.V. have further rights and responsibilities regarding sick time based on Dutch law, as written into their employment [contracts](https://github.com/daijapan/test/tree/master/contracts/#employee-contractor-agreements).
...
1. The People Ops Analyst will confirm there are no additional [tax implications](https://github.com/daijapan/test/tree/master/people-operations/code-of-conduct/#tax-implications-for-tuition-reimbursement-by-country) for reimbursement in the team member's country.
...
1. Why is awareness of Mental Health important at GitLab?
  ...
  * In the cold-light of business metrics, the healthier we are, [the more productive we are](https://www.rand.org/randeurope/research/projects/workplace-health-wellbeing-productivity.html.md).
...
* [United States Employment Status](https://github.com/daijapan/test/tree/master/contracts/#united-states-employment-status)
* [PIAA Agreements](https://github.com/daijapan/test/tree/master/contracts/#piaa-agreements)
* [360 Feedback](https://github.com/daijapan/test/tree/master/people-operations/360-feedback/index.html.md)
* [Return of Property](https://github.com/daijapan/test/tree/master/offboarding/#returning-property)
...
* [Parental Leave](https://github.com/daijapan/test/tree/master/benefits/#parental-leave)
* [Paid Time Off](https://github.com/daijapan/test/tree/master/paid-time-off/index.html.md)
* [Probationary Period](https://github.com/daijapan/test/tree/master/contracts/#sts=Probation Period - Confirmation Letter)
