...
GitLab is committed to serving our customers and employing individuals with personal standards consistent with that of our [values](https://github.com/daijapan/test/tree/master/values/index.html.md). This Code is designed to deter wrongdoing and to promote:
...
This Code should help guide your conduct in the course of our business. Many of the principles described in this Code are general in nature, and the Code does not cover every situation that may arise. Use common sense and good judgment in applying this Code. If you have any questions about applying the Code, please seek guidance. Not all information regarding the conduct of our business is found in this Code. Please review the applicable policies and procedures in specific areas as they apply as found in our [Team Handbook](https://github.com/daijapan/test/tree/master/index.html.md).
...
GitLab will promptly initiate an appropriate investigation into all possible violations of law and GitLab policy.  The Chief Culture Officer (CCO/index.html.md) or the HR Business Partner assigned to the business  will have the primary responsiblity for investigating complaints relating to employee misconduct.
...
GitLab will make all reasonable efforts to initiate an investigation into the allegation(s/index.html.md) and conclude the investigation in a timely fashion, as appropriate.  Depending on the type of investigation the steps and timeline for each investigation will vary.

**Investigation Findings**
Based on the investigation, GitLab investigator(s/index.html.md) will determine whether the allegation(s/index.html.md) were founded, unfounded or inconclusive.  This determination will be documented in writing and made part of the investigation report.  The determinations are as follows:
    * Violation Found.  Where a violation of GitLab policies, workplace rules or law is found to have occurred, the accused should be notified of the finding and of the specific corrective actions to be taken.  The accused employee's manager will also be notified if appropriate.  No details about the nature or extent of disciplinary or corrective actions will be disclosed to the complainant(s/index.html.md) or witness(es/index.html.md) unless there is as compelling reason to do so (e.g., personal safety/index.html.md)
    * No Violation Found.  In this situation, the complainant and the accused should be notified that GitLab investigated the allegation(s/index.html.md) and found that the evidence did not support the claim.
    * Inconclusive investigation.  IN some cases, the evidence may not conclusively indicate whether the allegation(s/index.html.md) was founded or unfounded.  If such a situation occurs, the notification a thorough investigation but has been unable to establish the truth or falsity of the allegation(s/index.html.md).  GitLab will take appropriate steps to ensure that the persons involved understand the requirements of GitLab's policies and applicable law, and that GitLab will monitor the situation to ensure compliance in the future.  

**How to Contact GitLab's 24-hour hotline:**

GitLab has engaged Lighthouse Services to provide an anonymous ethics and compliance hotline for all team members. The purpose of the service is to insure that any team member wishing to submit a report anonymously can do so without the fear of [retribution](#commitment-to-non-retaliation/index.html.md).

Reports may cover but are not limited to the following topics: Ethical violations, Wrongful Discharge, Unsafe Working Conditions, Internal Controls, Quality of Service, Vandalism and Sabotage, [Sexual Harassment](https://github.com/daijapan/test/tree/master/anti-harassment/#sts=Sexual Harassment/index.html.md), Theft, Discrimination, Conduct Violations, Alcohol and Substance Abuse, Threats, Fraud, Bribery and Kickbacks, Conflict of Interest, Improper Conduct, Theft and Embezzlement, Violation of Company Policy, Violation of the Law, Misuse of Company Property, Falsification of Contract, Reports or Records.
...
* Website: [https://www.lighthouse-services.com/gitlab](https://www.lighthouse-services.com/gitlab/index.html.md)
* USA Telephone:
...
* E-mail: reports@lighthouse-services.com (must include company name with report/index.html.md)
* Fax: (215/index.html.md) 689-3885 (must include company name with report/index.html.md)
...
* We do not tolerate discrimination against anyone--team members, customers, business partners, or other stakeholders--on the basis of race, color, religion, national origin, sex (including pregnancy/index.html.md), age, disability, HIV status, sexual orientation, gender identity, marital status, past or present military service ,or any other status protected by the laws or regulations in the locations where we operate.
...
GitLab’s confidentiality provisions can be found in the [employee and contractor templates](https://github.com/daijapan/test/tree/master/contracts/#employee-contractor-agreements/index.html.md), but these may vary from what you agreed to at the time of your contract. For specific information about your obligations regarding confidentiality, please reference your contract.

### Physical Assets and Resources

All employees and contractors must protect our [company assets](https://github.com/daijapan/test/tree/master/spending-company-money/index.html.md), such as equipment, inventory, supplies, cash, and information. Treat company assets with the same care you would if they were your own. No employee or contractor may commit theft, fraud or embezzlement, or misuse company property.
...
* We do not disclose any information about a third party without the written approval unless legally required to do so (for example, under a court-issued subpoena/index.html.md).

If you do not have a business reason to access this information, you should not do so. If you do, you must also take steps to protect the information against unauthorized use or release in line with our [Security Best Practices](https://github.com/daijapan/test/tree/master/security/index.html.md).

### Intellectual Property and Protecting IP

Our [intellectual property](https://github.com/daijapan/test/tree/master/contracts/#piaa-agreements/index.html.md) is among our most valuable assets. Intellectual property refers to creations of the human mind that are protected by various national laws and international treaties. Intellectual property includes copyrights, patents, trademarks, trade secrets, design rights, logos, expertise, and other intangible industrial or commercial property. We must protect and, when appropriate, enforce our intellectual property rights. We also respect the intellectual property belonging to third parties. It is our policy to not knowingly infringe upon the intellectual property rights of others.
...
1. As an employee or contractor, the things you create for GitLab belong to our company.
  * This work product includes inventions, discoveries, ideas, improvements, software programs, artwork, and works of authorship. This work product is our company’s property (it does not belong to individuals/index.html.md) if it is created or developed, in whole or in part, on company time, as part of your duties or through the use of company resources or information.
...
1. View our [DMCA policy](https://github.com/daijapan/test/tree/master/dmca/index.html.md) in regards to copyright / intellectual property violations

Assignment of intellectual property is addressed in the [employee and contractor templates](https://github.com/daijapan/test/tree/master/contracts/#employee-contractor-agreements/index.html.md), but these may vary from what you agreed to at the time of your contract. For specific information about your obligations regarding intellectual property rights and obligations, please reference your contract.
...
Legitimate sources of competitive information include:
  ...
  * from customers and suppliers (unless they are prohibited from sharing the information/index.html.md)
...
### Selection and Use of Third Parties/Procurement (Fair Purchasing/index.html.md)
...
1. The exchange of appropriate gifts and entertainment is often a way to build our business relationships. However, you must conduct business with customers, suppliers, and government agencies (including U.S. and non-U.S. governments/index.html.md) without giving or accepting bribes including (but not limited to/index.html.md) commercial bribery and kickbacks.
...
### Trade Compliance (Export/Import Control/index.html.md)
...
Records consist of all forms of information created or received by GitLab, whether originals or copies, regardless of media. Examples of company records include:
  ...
  * tape or any other medium (CD, DVD, USB data storage devices, etc./index.html.md) that contains information about our company or our business activities
...
Should any business or personal conflict of interest arise, or even appear to arise, you should [disclose it immediately to leadership for review](https://github.com/daijapan/test/tree/master/contracts/#approval-for-outside-projects/index.html.md). In some instances, disclosure may not be sufficient and we may require that the conduct be stopped or that actions taken be reversed where possible. As it is impossible to describe every potential conflict, we rely on you to exercise sound judgment, to seek advice when appropriate, and to adhere to the highest standards of integrity.
...
Team members will review and sign the [Code of Business Conduct & Ethics Acknowledgment Form](https://docs.google.com/document/d/1ehxrg-ieUEx1ARZv4LpysMfxzFmnhgtzmJn1-299g_E/edit?usp=sharing/index.html.md) during onboarding as well as annually during the [Global Compensation Annual Review](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#annual-compensation-review/index.html.md) cycle.
...
In keeping with our [values](https://github.com/daijapan/test/tree/master/values/index.html.md) of freedom, efficiency, transparency, kindness, and boring solutions, we have crafted the following protocol around sick leave for all GitLabbers.

**All GitLabbers**

- If you or a loved one is ill, we want you to take care of yourself or your loved one(s/index.html.md). To facilitate this, you should take sick leave when you need it. Sick leave is meant to be used when you are ill, or to care for family members including your parent(s/index.html.md), child(ren/index.html.md), spouse, registered domestic partner, grandparent(s/index.html.md), grandchild(ren/index.html.md), and sibling(s/index.html.md).
...
- If you need sick leave for more than 8 consecutive calendar days, notify your manager and People Ops to accommodate an extended leave request. What can (or must/index.html.md) be accommodated varies from location to location: GitLab will comply with the applicable laws in your specific location.
- Upon request, you should be able to provide proper documentation of the reason for your sick leave (doctor's note/index.html.md).

**Details for specific groups of GitLabbers**

- Employees of GitLab Inc. who receive a pay stub from TriNet will see sick time accrue on their pay stub at the rate of 0.0346 hrs per hour worked (3 hours of sick leave per semi-monthly pay-period/index.html.md) for a maximum accrual and carry-over of 72 hours per year. GitLab's policy is more generous than this, in the sense that you can take off non-accrued sick time as written above (a negative balance may show on your pay stub/index.html.md). Sick time does not get paid out in case of termination, nor does it reduce your final paycheck in case of a negative balance. Related to the topic of extended leave requests, see information about [short term disability](https://github.com/daijapan/test/tree/master/benefits/#std-ltd/index.html.md) through TriNet / your state.
- Employees of GitLab B.V. have further rights and responsibilities regarding sick time based on Dutch law, as written into their employment [contracts](https://github.com/daijapan/test/tree/master/contracts/#employee-contractor-agreements/index.html.md).
...
- If the employee is then on long-term sick leave (1 working week or more/index.html.md) depending on the situation and agreement with the employee, People Operations will instruct HRSavvy to register the employee at the occupational health and safety service.
...
a/index.html.md) candidates for employment will not be working directly for or supervising a significant other or relative,
b/index.html.md) candidates for employment will not occupy a position in which they may be privy to confidential, highly sensitive information that the significant other or relative **should not** have access to, *and*
c/index.html.md) candidates for employment will not occupy a position in the same line of authority in which employees can initiate or participate in decisions involving a direct benefit to the significant other or relative. Such decisions include hiring, retention, transfer, promotion, wages, and leave requests.
...
- If your relocation is to a different metro area, then to stay aligned with our [compensation principles](https://github.com/daijapan/test/tree/master/people-operations/global-compensation-calculator/#compensation-principles/index.html.md) and per the [standard contract agreements](https://github.com/daijapan/test/tree/master/contracts/index.html.md), you should obtain written agreement first from your manager and then from People Operations. You must have approval 30 days prior to any official move. If you are considering a move it is best to discuss this with your manager as soon as posible, not after you have actually moved, to understand the impact to compensation or your role at GitLab.  In almost all situations the compensation may change.  In some instances a move will not align to your proposed location, (e.g. a recruiter hired in EMEA to support EMEA would not be approved to move to the US/index.html.md).  It is the company's discretion to offer you a contract in your new location or to not continue with your contract based on a relocation. For an idea about the impact please see our [move calculator](/job-families/move/index.html.md). The move calculator may not always yield accurate results. Run your move past our People Operations Analyst and Chief Culture Officer for an accurate salary in the new [geographical area](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#geographical-areas/index.html.md).
...
GitLabbers are eligible for a reimbursement of up to [4,000 USD](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) per calendar year (January 1st - December 31st/index.html.md). There is no limit to the number of years a team member can participate in the program. Courses eligible for reimbursement include for credit classes resulting in a grade (not pass/fail/index.html.md), courses providing continuing
...
Additional fees related to parking, books, supplies, technology, or administrative charges are not covered as part of the program. Tuition will be validated by receipt of payment. A description of the course(s/index.html.md) and degree or certification program along with a
...
1. If the manager agrees that the degree or certification program is aligned with the business and growth opportunities within GitLab, a minimum of three weeks prior to the course start date, the GitLabber fills out a [Tuition Reimbursement Agreement](https://docs.google.com/document/d/1-WvPzoUMpcaUUOm3Gl5eDKQDw_-TtI4J0LP5ifMa8Vo/edit/index.html.md) and forwards it to People Ops to stage for the proper signatures (GitLabber, Manager, People Operations/index.html.md) in HelloSign.
1. The People Ops Analyst will confirm there are no additional [tax implications](https://github.com/daijapan/test/tree/master/people-operations/code-of-conduct/#tax-implications-for-tuition-reimbursement-by-country/index.html.md) for reimbursement in the team member's country.
...
* The World Health Organisation (WHO/index.html.md) [defines health](https://www.google.co.uk/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&ved=0ahUKEwj3oZ7I1M_XAhUsI8AKHXWiC5EQFggmMAA&url=http%3A%2F%2Fwww.who.int%2Fgovernance%2Feb%2Fwho_constitution_en.pdf&usg=AOvVaw0usN4G0kSEScrW3HqENGIr/index.html.md) as:
...
* The WHO [defines mental health](http://www.who.int/features/factfiles/mental_health/en/index.html.md) as:
...
1. Why is awareness of Mental Health important at GitLab?
  * It can affect any and all of us.  The statistics from the WHO are that [1 in 4](http://www.who.int/whr/2001/media_centre/press_release/en/index.html.md) of us will be affected by mental or neurological disorders at some point in our life.  That said, we are all subject to periods where we or those around us find the "the normal stresses of life" harder than usual to deal with.
  ...
  * GitLab can offer "productive and fruitful" work for all of our employees.  That should not be [underestimated](https://www.google.co.uk/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&cad=rja&uact=8&ved=0ahUKEwitr7eP18_XAhWIORoKHY2_CA4QFggrMAA&url=https%3A%2F%2Fcardinal-management.co.uk%2Fwp-content%2Fuploads%2F2016%2F04%2FBurton-Waddell-is-work-good-for-you.pdf&usg=AOvVaw0ROXJdWquGML5bIsBEIRLo/index.html.md).
  * In the cold-light of business metrics, the healthier we are, [the more productive we are](https://www.rand.org/randeurope/research/projects/workplace-health-wellbeing-productivity.html/index.html.md).
...
1. What are we doing to get there?
  * Per an open [issue](https://gitlab.com/gitlab-com/peopleops/issues/138/index.html.md), People Operations will be developing training for managers on this topic.
  * Talk about mental health issues and ideas in the [#mental_health_aware](https://gitlab.slack.com/messages/C834CM4HW/index.html.md) Slack channel.
  * GitLab would also like to encourage GitLabbers to take their [time off](https://github.com/daijapan/test/tree/master/paid-time-off/index.html.md) to properly take care of themselves. We encourage the team to go to yoga, take a long lunch, or anything else in their day to day life that assists in their mental and emotional well-being.
  * In addition to our current EAP programs available for employees, we encourage GitLabbers to take a look at [Working Through It](http://www.workplacestrategiesformentalhealth.com/wti/Home.aspx/index.html.md) for insight into reclaiming well-being at work, off work, and return to work.
...
We will obtain employment and criminal background checks for team members based on specific project, client, and/or department assignments. Team members in Support Engineer and Solutions Architect positions, People Ops, Finance, Sales (client-dependent/index.html.md), and the Executive team have been selected to go through this process. Other positions/departments may be added in the future based on business requirements.

We have contracted with [Checkr](https://checkr.com/index.html.md) to perform these background checks, which will cover criminal history for the last 7 years and employment history for the last 5 years and/or the three most recent employers. GitLab may use the returned background check information to make decisions regarding employment; therefore, the employment of those in the affected positions is contingent upon a successful completion of the background check. Due to the remote nature of our company, offenses involving driving or motor vehicles are not considered actionable violations.
...
To prepare for the employment application process, please gather each previous employer's name and address, your position title held, employment start and end dates, manager’s name and title, their phone number, and email address. Details for a Human Resources contact can be entered instead of a manager's contact details. If you have been self-employed, you must provide backup documentation to act as proof of employment. This documentation can be in the form of tax returns (e.g. W2s/index.html.md), pay stubs, LLC documentation, official company registrations, etc.
...
When a team member is absent from work for three consecutive workdays, there is no entry on the availability calendar for time off, and fails to contact his or her supervisor, they can be [terminated](https://github.com/daijapan/test/tree/master/offboarding/#involuntary-terminations/index.html.md) for job abandonment unless otherwise required by law.
...
* [United States Employment Status](https://github.com/daijapan/test/tree/master/contracts/#united-states-employment-status/index.html.md)
* [PIAA Agreements](https://github.com/daijapan/test/tree/master/contracts/#piaa-agreements/index.html.md)
* [360 Feedback](https://github.com/daijapan/test/tree/master/people-operations/360-feedback/index.html.md)
* [Return of Property](https://github.com/daijapan/test/tree/master/offboarding/#returning-property/index.html.md)
* [Promotions and Transfers](https://github.com/daijapan/test/tree/master/people-operations/promotions-transfers/index.html.md)
* [General Benefits](https://github.com/daijapan/test/tree/master/benefits/index.html.md)
* [Entity Specific Benefits](https://github.com/daijapan/test/tree/master/benefits/#entity-specific-benefits/index.html.md)
* [Parental Leave](https://github.com/daijapan/test/tree/master/benefits/#parental-leave/index.html.md)
* [Paid Time Off](https://github.com/daijapan/test/tree/master/paid-time-off/index.html.md)
* [Probationary Period](https://github.com/daijapan/test/tree/master/contracts/#sts=Probation Period - Confirmation Letter/index.html.md)
