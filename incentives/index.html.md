...
GitLabbers (not just the Sales team) for every month that we reach our IACV Targets. The incentive is [100 USD](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates)
...
- You should spend the incentive on eating out, and can be reimbursed _up to_ the maximum of [100 USD](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates).
...
1. For values based bonuses please see [Tinggly](https://github.com/daijapan/test/tree/master/incentives/#tinggly)
...
1. What are the different levels of experiences and how are they awarded?
  ...
  * Ultimate Collection (Valued at $279 USD): Awarded to the team member who is selected as the [Top Team Member](https://github.com/daijapan/test/tree/master/incentives/#top-team-member) each quarter.
  * Bucket List (Prices Vary): Bucket List items are reserved for Executive team nominations for extraordinary performance and alignment with our [values](https://github.com/daijapan/test/tree/master/values/index.html.md). The gift must be approved by the Chief Culture Officer and the CEO.
...
1. A Top Team Member (T2M) exemplifies the [GitLab Values](https://github.com/daijapan/test/tree/master/values/index.html.md) beyond of the [team of people](/team/structure/) they directly work with.
1. Each quarter People Ops will request managers to nominate a team member who is not on their own team to receive the T2M award. All team members can submit nominations, but just ping your manager in the issue to upvote.
  ...
  * The T2M award will be announced on the [Company Call](https://github.com/daijapan/test/tree/master/communication/#company-call) to recognize the team member and posted on the culture page.
...
1. We want to encourage and support [diversity](https://github.com/daijapan/test/tree/master/values/index.html.md) and [frugality](https://github.com/daijapan/test/tree/master/values/index.html.md) on our team and in our hiring practices, so we will offer the following referral bonuses once the new team member has been with the company for 3 months.
    * Any great candidate that is referred and hired will earn a GitLab employee a [$1,000](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates) bonus once the new team member has been with the company for 3 months.
    * We will offer a [$1500](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates) referral bonus for hires from Rent Index less than 0.7.
...
* Please read about [how to make a referral](https://github.com/daijapan/test/tree/master/hiring/greenhouse/#making-a-referral) for more information.
