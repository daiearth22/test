...
The following incentives are available for GitLabbers. Also see our separate page on [benefits](https://github.com/daijapan/test/tree/master/benefits/index.html.md) available to GitLabbers.
...
GitLabbers (not just the Sales team/index.html.md) for every month that we reach our IACV Targets. The incentive is [100 USD](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md)
...
- Every Monday the Director of Sales Ops posts the progress of Incremental Annual Contract Value (IACV/index.html.md) bookings against plan in the wins channel.   Director of Sales Ops also posts progress dashboard when 25%, 50%, 75% and 100% of monthly thresholds are achieved.
- At the end of each month, when bookings are finalized, Director of Sales Ops announces on the Company call the achievement of Incremental Annual Contract Value (IACV/index.html.md) as a percentage of plan and whether or not the sales evangelism dinner has been earned.  Sales Ops also announces the next month's target for IACV.
...
- You should spend the incentive on eating out, and can be reimbursed _up to_ the maximum of [100 USD](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md).
...
- If you cannot, or decide not to, use the incentive in the expected month, you can carry it over to the next month by notifying [Accounts Payable](mailto:ap@gitlab.com/index.html.md) before the 22nd of the month (release day!/index.html.md). You can only carry over one month in this way.
...
1. For values based bonuses please see [Tinggly](https://github.com/daijapan/test/tree/master/incentives/#tinggly/index.html.md)

#### Process for Recommending a Team Member for a Bonus in BambooHR

**Manager (Reports To/index.html.md):**
...
1. In a comment in the request in BambooHR, include _only_ the link to a google doc that details how the GitLabber demonstrated our [values](https://github.com/daijapan/test/tree/master/values/index.html.md). This doc should be comment-able to everyone at GitLab.
...
1. **Never** hit submit. (It will cause the entire payroll to be paid the next day/index.html.md)
...
[Tinggly](https://www.tinggly.com/index.html.md) is a gift platform containing hundreds of different experiences. Purchasing a gift level gives the recipient access to an entire collection of experiences to choose from. Gifts are hand delivered in a specially designed package for GitLab. Experiences are available in over 100 countries across the globe and are valid for 24 months after purchase.

1. What are the different levels of experiences and how are they awarded?
  * Essential Collection (Valued at $79 USD/index.html.md):  Peer to peer nominations.
  * Premium Collection (Valued at $119 USD/index.html.md): Manager nominating a team member.
  * Ultimate Collection (Valued at $279 USD/index.html.md): Awarded to the team member who is selected as the [Top Team Member](https://github.com/daijapan/test/tree/master/incentives/#top-team-member/index.html.md) each quarter.
  * Bucket List (Prices Vary/index.html.md): Bucket List items are reserved for Executive team nominations for extraordinary performance and alignment with our [values](https://github.com/daijapan/test/tree/master/values/index.html.md). The gift must be approved by the Chief Culture Officer and the CEO.
...
1. What are some pointers for nominating a peer?
  ...
  * Example of a recommendation that will be approved: "A team member, outside my team, went above and beyond training me on git so I can be more productive." This team member should be rewarded for collaboration with a Tinggly Essential experience (peer to peer nomination/index.html.md).

#### Top Team Member

1. A Top Team Member (T2M/index.html.md) exemplifies the [GitLab Values](https://github.com/daijapan/test/tree/master/values/index.html.md) beyond of the [team of people](/team/structure/index.html.md) they directly work with.
1. Each quarter People Ops will request managers to nominate a team member who is not on their own team to receive the T2M award. All team members can submit nominations, but just ping your manager in the issue to upvote.
  * The request will be sent on the 5th of month and nominations will close at the end of the day (EST/index.html.md) on the 10th. The prize will be awarded on the 15th or the following business day (if on a weekend/index.html.md). The People Ops Analyst will tally the nominations. The decision will be finalized by a review committee made up of the Chief Culture Officer, CEO, CTO and the VP of Product. The executive team member of the winner will confirm the award to ensure there are no pending performance issues.
  * Nominations should focus on efforts and explain specific situations that represent any of our [values](https://github.com/daijapan/test/tree/master/values/index.html.md).
  * The T2M award will be announced on the [Company Call](https://github.com/daijapan/test/tree/master/communication/#company-call/index.html.md) to recognize the team member and posted on the culture page.
1. The award will be an experience from the [Tinggly Ultimate Collection](https://www.tinggly.com/collections/ultimate/index.html.md).
 ...
 * For countries where Tinggly is known to not have many experiences available (currently, India/index.html.md) please send the team member swag codes with the equivalent amount.
 * You will need their address and phone number for shipping.
 * Go to [Tinggly's website](https://www.tinggly.com/index.html.md), select the collection type awarded, click "Buy a Gift", choose Gift Box, enter in the buyer's information and the delivery information, and personalize the voucher with why the team member was awarded the experience. To pay, use the appropriate code stored in the People Ops Vault in 1Password and click the box for "I have a discount." Click "Buy."
...
also be fantastic additions to our [Team](/team/index.html.md) and who
may be interested in one of the current [Job Openings](/jobs/index.html.md).
To help us grow the team with exceptional people, we have referral bonuses that work as follows:

1. We want to encourage and support [diversity](https://github.com/daijapan/test/tree/master/values/index.html.md) and [frugality](https://github.com/daijapan/test/tree/master/values/index.html.md) on our team and in our hiring practices, so we will offer the following referral bonuses once the new team member has been with the company for 3 months.
    * Any great candidate that is referred and hired will earn a GitLab employee a [$1,000](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) bonus once the new team member has been with the company for 3 months.
    * We will offer a [$1500](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) referral bonus for hires from Rent Index less than 0.7.
    * We will offer a [$2000](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) referral bonus for hires to teams with ["underrepresented groups"](http://seldo.com/weblog/2014/06/25/a_comparison_of_diversity_at_three_major_tech_companies/index.html.md). "Underrepresented groups" may refer to women, people of color, Hispanic/Latino people, veterans, or others, but it may also be defined differently from department to department and is subject to change as those departments grows more diverse. People Ops will confirm the bonus amount when it is entered into BambooHR.
...
_Exceptions: no bonuses for hiring people who report to you, and no bonus for the executive team (VP and above/index.html.md)._
...
* Please read about [how to make a referral](https://github.com/daijapan/test/tree/master/hiring/greenhouse/#making-a-referral/index.html.md) for more information.
...
1. Enter a note stating that this is a future bonus (this will be changed once the bonus has been paid/index.html.md)

#### Notification to Process a Bonus

BambooHR will send an email to PeopleOps on the date that the referral bonus should be paid for processing through the applicable payroll system. If the team member is a contractor, send them an email (and cc Finance/index.html.md) to invoice the bonus.
Once the bonus has been processed, change the note in BambooHR to denote the referral bonus has been paid.

### Visiting grant

GitLab is an [all-remote company](http://www.remoteonly.org/index.html.md) with GitLabbers all over the world (see the map on our [Team page](/team/index.html.md). If you want to visit other team members to get to know them, GitLab will pay for your travel expenses. You don't need to work on the same project or team, either, so long as you discuss work for at least part of the time you're meeting. GitLab will pay for **flights, trains, and transportation to and from the airport,** up to a total of [$150](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) per team member that you visit and work with.
...
There are many regular meet-ups of GitLabbers in many cities. We have a [shared calendar][meetup-calendar] to view the schedule. Subscribe to it, make use of the visiting grant, and join meet-ups near you (or far away!/index.html.md).

Douwe and Robert took advantage of the visiting grant when they traveled to [49 different colleagues in 20 cities, in 14 countries, on five continents, in 6 months](/2017/01/31/around-the-world-in-6-releases/index.html.md). Inspired by them, Dimitrie went on a similar journey and provided a [great template](https://docs.google.com/spreadsheets/d/1Cwi2PfO1HeDm8Lap9J2tPmfYFaC8AmmKQg1fCmtdGI4/edit?usp=sharing/index.html.md). Also, check out [tips on working remotely while abroad](/culture/remote-only/#tips-on-working-remotely-while-abroad/index.html.md).

To claim the grant, include a line item on your expense report or invoice with a list of the team members you visited. The expense report may be submitted during the first month of travel or up to 3 months after your trip has concluded. That said, if it's more [frugal](https://github.com/daijapan/test/tree/master/values/#efficiency/index.html.md) to book and expense your travel further in advance, please do so.
...
Every GitLab employee can request the [Gold](/pricing/#gitlab-com/index.html.md) tier for GitLab.com.
In case an employee has separate private and work accounts on GitLab.com, they can request it for both.

In order to request this benefit please open an issue in the [internal services issue tracker](https://gitlab.com/gitlab-com/support/services/services-internal/issues?scope=all&utf8=%E2%9C%93&state=all/index.html.md) with the title [GitLab.com Gold tier request: @username]
