...
* [Sales Training](https://github.com/daijapan/test/tree/master/sales-training/index.html.md)
* [Lead Qual & Demand Gen](https://github.com/daijapan/test/tree/master/marketing/demand-generation/)
...
* [How to manage deals](https://github.com/daijapan/test/tree/master/sales-process/deal_management_process)
* [Managing an account](https://github.com/daijapan/test/tree/master/sales-process/account_management/index.html.md)
* [Licenses and EE access](https://github.com/daijapan/test/tree/master/sales-process/licenses)
...
Before prospecting and engaging with a prospect, check to see if they are using CE. To do this, use GitLab Version Check. Everything about [GitLab Version Check](https://github.com/daijapan/test/tree/master/sales-process/version_check/index.html.md).
...
* Any deal coming from Gitorious has â€(from Gitorious)â€ added.  Example MicahTek, Inc.-Gitorious-Standard-1
...
### [Opportunity Stages](https://github.com/daijapan/test/tree/master/business-ops/#sts=Opportunity Stages) <a name="stages"></a>
...
Once you close a deal that includes Premium Support, you need to follow the steps outlined in [Premium Support Customer Onboarding](https://github.com/daijapan/test/tree/master/customer-success/premium_support_on-boarding/index.html.md).
...
1. Sales receives an order (one of the three options):
    ...
    * an e-mail agreement (â€œwe accept the quote/subscription/etcâ€) or any other written statement. If order is a signed quote or written agreement, email and ask if there is a PO pending and get the PO number
...
Additional billing situations [Accounting procedures](https://github.com/daijapan/test/tree/master/sales-process/accounting/index.html.md)
...
authority of license exception TSU of section [740.13(e)](https://www.bis.doc.gov/index.php/forms-documents/doc_view/986-740/index.html.md) of the export administration regulations (EAR).
