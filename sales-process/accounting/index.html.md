...
1. Fill in VAT field (if needed/index.html.md)
...
* Enter the unit amount and any other relevant details, then click the Add Charge button (it’s a good rule of thumb to include a description with the charge. The description will display with the line item on the customer’s invoice/index.html.md)
...
* Terms: Net 30 (or 60/index.html.md)
...
Do the VIES check before sending an invoice to a EU client (not needed for Dutch clients) [VAT request](http://ec.europa.eu/taxation_customs/vies/vatRequest.html.md) print to PDF, email the resulting page to Sytse with the invoice.
...
1. Fill out the ICL details if needed (Services, date of new invoice/index.html.md)

1. Send PDF

1. Send the credit invoice to the customer (this is legally required/index.html.md)
...
You can find additional documentation [here](https://docs.recurly.com/hosted-account-management/index.html.md).
