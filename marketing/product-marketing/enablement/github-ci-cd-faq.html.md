...
A: Yes, [https://about.gitlab.com/features/github](https://about.gitlab.com/features/github) [will go live 2018-03-22]
...
It is part of our Premium (Self-hosted/index.html.md) & Silver (GitLab.com) Tiers - $19 /user /month (For all GitLab Premium features including CI/CD for GitHub.)
...
A: No, GitLab CI/CD for GitHub is being [released and launched](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/marketing/product-marketing/#release-vs-launch) on the same day. As such, it will not be available for customers to use until after GitLab 10.6  is released on 2018-03-22.
