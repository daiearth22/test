...
1. [Set up a cluster on Google Kubernetes Engine (GKE)](../gke-setup/index.html.md)
1. [set up a cluster on Azure Container Service (ACS)](../acs-setup/index.html.md)
...
> * Copy `(1 - ((node_memory_MemFree + node_memory_Cached/index.html.md) / node_memory_MemTotal)) * 100` into the Expression Bar; hit enter.
