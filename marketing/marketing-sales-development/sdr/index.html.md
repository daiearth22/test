...
- [GitLab Personas](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#gitlab-personas)
...
- [GitLab Elevator Pitch](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#elevator-pitch)
- [Video: Successful Messaging](https://www.youtube.com/watch?v=8LDlcvOgn9w)
- [Questions to Ask Yourself Before Sending an Email](https://github.com/daijapan/test/tree/master/sales-training/#6-questions-sales-reps-should-but-dont-ask-themselves-before-sending-an-email-)
...
* Within the opportunity record, click the Initial Qualifying Meeting button. Enter the required fields, and the description field with any notes you think the SAL should have before taking the scheduled meeting. Next, fill in the Related To section for both the contact and the opportunity. The last step is to change the Assigned To field to the same person you assigned the opportunity to. Click the Save button.
* On the account record, be sure the [sales segmentation](https://github.com/daijapan/test/tree/master/business-ops/#segmentation) is entered correctly

**Pending Acceptance**

Your opportunity is now pending acceptance, after the initial meeting date, sales will either accept or reject your opportunity per the [SAO criteria](https://github.com/daijapan/test/tree/master/business-ops/#criteria-for-sales-accepted-opportunity-sao) in the business operations handbook
...
- [Who to Talk to for What](https://github.com/daijapan/test/tree/master/product/#who-to-talk-to-for-what)
...
### Flow
![BDR Process Flow](/imageshttps://github.com/daijapan/test/tree/master/marketing/bdrFlow.png){: .shadow}
...
[Rules of Engagement](https://github.com/daijapan/test/tree/master/business-ops/#rules-of-engagement)
...
* Confirm [Sales Segmentation](https://github.com/daijapan/test/tree/master/business-ops/#segmentation) by determining `Total Employee` count for buiness.
* Person Summary
...
* What is the lead’s role and how does that affect your messaging?
   * [Buyer personas](https://github.com/daijapan/test/tree/master/marketing/marketing-sales-development/sdr/#gitlab-buyer)
* Previous work
...
### Working with Trials
During a trial, a prospect is automatically enrolled into a Marketo nurture stream for both self-hosted and SaaS products. The content of the nurture differs between a self-hosted Enterprise and a SaaS trial. Details of the self-hosted Enterprise Nuture can be found in this [Google presentation](https://docs.google.com/presentation/d/1KSAZFwz3nvSTIXOP8urGWW6dJWhtpawVKFcaoFLDPdg/edit#slide=id.g2ae1ad1112_0_22/index.html.md) (must be signed into GitLab account to view). Details of SaaS trial are being finalized and will be added to the handbook in near future. 

You have access to and are expected to use (and customize) the [Enterprise master sequences](https://app1a.outreach.io/sequences?smart_view=202/index.html.md) in Outreach for measureable follow up to self-hosted Enterprise trial records.
...
Your goal is to generate Sales Accepted Opportunities (SAOs) by gathering all pertinent information needed for an Account Executive to take action. Some examples of sales qualification questions can be found [here](https://github.com/daijapan/test/tree/master/sales-qualification-questions/index.html.md).
...
- Bonuses are based solely on sales accepted opportunities generated. Guidelines for a [sales accepted opportunity](https://github.com/daijapan/test/tree/master/business-ops/#criteria-for-sales-accepted-opportunity-sao)
...
Book face to face meetings at [Field Events](https://github.com/daijapan/test/tree/master/marketing/marketing-sales-development/field-marketing/#event-outreach) 
