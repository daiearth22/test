...
- [GitLab Personas](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#gitlab-personas/index.html.md)
...
- [Software Development Lifecycle](/sdlc/index.html.md)
- [Glossary of Terms](https://docs.gitlab.com/ee/university/glossary/index.html.md)
...
- [GitLab Compared](/comparison/index.html.md)
...
- [Customer Use-Cases](https://github.com/daijapan/test/tree/master/use-cases/index.html.md)
- [Customer Stories](/blog/categories/customer-stories/index.html.md)
- [GitLab Sales Demo](https://github.com/daijapan/test/tree/master/marketing/product-marketing/demo/index.html.md)
...
- [GitLab Elevator Pitch](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#elevator-pitch/index.html.md)
- [Video: Successful Messaging](https://www.youtube.com/watch?v=8LDlcvOgn9w/index.html.md)
- [Questions to Ask Yourself Before Sending an Email](https://github.com/daijapan/test/tree/master/sales-training/#6-questions-sales-reps-should-but-dont-ask-themselves-before-sending-an-email-/index.html.md)
- [How to Write the Perfect Sales Email](https://www.saleshacker.com/how-to-write-the-perfect-sales-email/index.html.md)
...
* On the contact record, click on the New Opportunity button, enter all required fields: opportunity name ([see Opportunity Naming Convention](https://github.com/daijapan/test/tree/master/sales-process/images_sales_process/#opportunity-naming-convention-/index.html.md)  for the correct format/index.html.md), stage, type, and close date. Update the contact role field (i.e. business user, champion, decision maker, influencer, evaluator/index.html.md). Next, change the opportunity owner to the account owner (SAL/index.html.md). Click the Save button.
* When creating an opportunity from contacts that still need to be qualified make sure that the opportunities are opened in stage [`00-Pre Opportunity`](https://github.com/daijapan/test/tree/master/business-ops/#opportunity-stages/index.html.md). Then in order to qualify the contact, use the qualification questions on the opportunity in the same manner that we use qualification questions on leads.
...
* On the lead record, click on the convert button, enter all required fields: opportunity name ([see Opportunity Naming Convention](https://github.com/daijapan/test/tree/master/sales-process/images_sales_process/#opportunity-naming-convention-/index.html.md) for the correct format/index.html.md), stage, type, and close date. Update the contact role field (i.e., business user, champion, decision maker, influencer, evaluator/index.html.md). Next, change the opportunity owner to the account owner (AE, SAL/index.html.md). Click the Save button.
* Within the opportunity record, click the Initial Qualifying Meeting button. Enter the required fields, and the description field with any notes you think the SAL should have before taking the scheduled meeting. Next, fill in the Related To section for both the contact and the opportunity. The last step is to change the Assigned To field to the same person you assigned the opportunity to. Click the Save button.
* On the account record, be sure the [sales segmentation](https://github.com/daijapan/test/tree/master/business-ops/#segmentation/index.html.md) is entered correctly

**Pending Acceptance**

Your opportunity is now pending acceptance, after the initial meeting date, sales will either accept or reject your opportunity per the [SAO criteria](https://github.com/daijapan/test/tree/master/business-ops/#criteria-for-sales-accepted-opportunity-sao/index.html.md) in the business operations handbook
...
- [Business Operations Handbook](https://github.com/daijapan/test/tree/master/business-ops/index.html.md)
- [Marketing Handbook](https://github.com/daijapan/test/tree/master/marketing/index.html.md)
- [Sales Handbook](https://github.com/daijapan/test/tree/master/sales/index.html.md)
- [Customer Success Handbook](https://github.com/daijapan/test/tree/master/customer-success/index.html.md)
...
- [GitLab Resources](/resources/index.html.md)
- [GitLab Blog](/blog/index.html.md)
- [GLU GitLab University](https://docs.gitlab.com/ee/university/index.html.md)
- [GitLab Primer](/primer/index.html.md)
- [Sales Qualification Questions](https://github.com/daijapan/test/tree/master/sales-qualification-questions/index.html.md)
- [FAQ from Prospects](https://github.com/daijapan/test/tree/master/sales-faq-from-prospects/index.html.md)
- [Platzi GitLab Workshop](https://courses.platzi.com/classes/git-gitlab/index.html.md)
- [GitLab Documentation](http://docs.gitlab.com/ee/index.html.md)
...
- [Tech Stack](https://github.com/daijapan/test/tree/master/business-ops/#tech-stack/index.html.md)
...
- [Outreach University](https://university.outreach.io/index.html.md)
...
- [Salesforce Trailhead Training](https://www.salesforce.com/services/training/overview/index.html.md)
...
- [Hacker News](https://news.ycombinator.com/index.html.md)
- [Martin Fowler](https://martinfowler.com/index.html.md)
- [The New Stack](https://thenewstack.io/index.html.md)
- [Top 13 DevOps Blogs You Should Be Reading](https://stackify.com/top-devops-blogs/index.html.md)
...
- [Who to Talk to for What](https://github.com/daijapan/test/tree/master/product/#who-to-talk-to-for-what/index.html.md)
...
### Flow
![BDR Process Flow](/imageshttps://github.com/daijapan/test/tree/master/marketing/bdrFlow.png/index.html.md){: .shadow}
...
[Glossary](https://github.com/daijapan/test/tree/master/business-ops/#glossary/index.html.md)

[Customer Lifecycle](https://github.com/daijapan/test/tree/master/business-ops/#customer-lifecycle/index.html.md)

[Lead Management](https://github.com/daijapan/test/tree/master/business-ops/#lead-management/index.html.md)
...
[Rules of Engagement](https://github.com/daijapan/test/tree/master/business-ops/#rules-of-engagement/index.html.md)
...
* Confirm [Sales Segmentation](https://github.com/daijapan/test/tree/master/business-ops/#segmentation/index.html.md) by determining `Total Employee` count for buiness.
* Person Summary
...
* What is the lead’s role and how does that affect your messaging?
   * [Buyer personas](https://github.com/daijapan/test/tree/master/marketing/marketing-sales-development/sdr/#gitlab-buyer/index.html.md)
* Previous work
...
You can see who else is online by viewing the [GitLab Team Profile](https://gitlabteam.drift.com/index.html.md).
...
Your goal is to generate Sales Accepted Opportunities (SAOs/index.html.md) by gathering all pertinent information needed for an Account Executive to take action. Some examples of sales qualification questions can be found [here](https://github.com/daijapan/test/tree/master/sales-qualification-questions/index.html.md).
...
- Bonuses are based solely on sales accepted opportunities generated. Guidelines for a [sales accepted opportunity](https://github.com/daijapan/test/tree/master/business-ops/#criteria-for-sales-accepted-opportunity-sao/index.html.md)
...
Book face to face meetings at [Field Events](https://github.com/daijapan/test/tree/master/marketing/marketing-sales-development/field-marketing/#event-outreach/index.html.md) 
