...
- [GitLab blog](https://github.com/daijapan/test/tree/master/marketing/blog/index.html.md)
- [Case studies guide](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/content/case-studies/index.html.md)
- [Editorial calendar](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/content/editorial-calendar/index.html.md)
- [Editorial review checklist](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/content/editorial-review-checklist/index.html.md)
- [Social media guidelines](https://github.com/daijapan/test/tree/master/marketing/social-media-guidelines/index.html.md)
- [Content Hack Day](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/content/content-hack-day/index.html.md)
- [Newsletters](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/content/newsletters/index.html.md)
- [User spotlights](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/content/user-spotlights/index.html.md)
...
### Issue trackers
  - [General Content Marketing](https://gitlab.com/gitlab-com/marketing/general/boards/104871?=/index.html.md)
  - [Blog posts](https://gitlab.com/gitlab-com/blog-posts/boards/409030/index.html.md)
  - [Webcasts](https://gitlab.com/gitlab-com/marketing/general/boards/356113?=/index.html.md)
  - [Case studies](https://gitlab.com/gitlab-com/marketing/general/boards/361043?=/index.html.md)
  - [FY 2018 Q1 OKRs](https://gitlab.com/gitlab-com/marketing/general/boards/444717?scope=all&utf8=%E2%9C%93&state=opened&milestone_title=Q1%202018/index.html.md)

### Team
- **Erica Lindberg, Manager, Content Marketing**
  - Area of focus: Leadership, case studies
  - Contact: [@erica](https://gitlab.com/erica/index.html.md)
- **Rebecca Dodd, Content Editor**
  - Area of focus: Blog endboss, editing blog posts
  - Contact: [@rebecca](https://gitlab.com/rebecca/index.html.md)
- **Emily von Hoffmann, Associate Social Marketing Manager**
  - Area of focus: Social media and Medium (50%/index.html.md), Net new content for GitLab blog (50%/index.html.md)
  - Contact: [@evhoffmann](https://gitlab.com/evhoffmann/index.html.md)
- **Aricka Flowers, Content Marketing Associate**
  - Area of focus: Writing net new content for GitLab blog (100%/index.html.md)
  - Contact: [@atflowers](https://gitlab.com/atflowers/index.html.md)
- **Suri Patel, Content Marketing Associate**
  - Area of focus: Writing new content for GitLab blog (100%/index.html.md)
  - Contact: [@spatel](https://gitlab.com/suripatel/index.html.md)
...
To create a campaign brief, first start with the "campaign brief template" (which can be found by searching on the google drive/index.html.md). Fill out all fields in the brief as completely as possible. Certain fields might not be applicable to a particular campaign. For example, an email nurture campaign leveraging text based emails won’t have a visual design component. This field can be left blank in that example.
...
* Set the appropriate due date (the due date should be the campaign launch date/index.html.md)
...
**Pre-giveaway**
1. Create an issue and tag Emily von Hoffmann (@evhoffmann/index.html.md) to determine the
rules of engagement and Emily Kyle (@emily/index.html.md) for prizes.
2. Create and publish an [Official Sweepstakes Rules page](#officialrules/index.html.md)
...
- Set a launch date
- Ask for social image(s/index.html.md) with text (if organic posts only/index.html.md) explaining the offer/ask
...
- Finalize the delivery method: form vs. tweets vs. retweets, depending on the goals of the campaign
    - Pros of a form: Neat, uniform, easy for us to keep track of, no downsides of low engagement (i.e., responses not visible/index.html.md)
...
- Finalize the ask, making sure it's extremely clear what you want to happen (`Share your GitLab story!` `Tell us your favorite thing you made with GitLab` `tell us a time GitLab helped you out of a tight spot`/index.html.md)
...
- Finalize hashtag
- Ask community advocates to review all copy (tweets, form, blog post/index.html.md) and adjust according to their suggestions
...
#### Day of giveaway
- If you have entries for the giveaway in a spreadsheet, use [random.org](https://www.random.org/index.html.md) to generate a random number. Match the number to the corresponding row in your spreadsheet to identify the winner. **Never enter email addresses or personal information of participants into a third-party site or system we do not control.**
- Try to schedule first push or ask a team member to tweet the first announcement early (ex: around 4 am PT/index.html.md) to try to have some overlap with all our timezones
...
3. Add the content of [this template](https://gitlab.com/gitlab-com/marketing/general/blob/0252a95b6b3b5cd87d537dabf3d1675023f1d07d/sweepstakes-official-rules-template.md/index.html.md) to the `index.html.md` file.
...
**Format:**
* Create [tracked links](https://docs.google.com/spreadsheets/d/12jm8q13e3-JNDbJ5-DBJbSAGprLamrilWIBka875gDI/edit#gid=0/index.html.md) for every link back to about.gitlab.com (e.g., all blog posts, landing pages, etc./index.html.md)
* Publish and schedule in Sprout, using the “shorten links� button
* Choose a tag for every post that goes out (there is a dropdown/index.html.md)
* Preview posts in Sprout to make sure spacing, image, etc. looks fine on desktop and mobile

**Timing:**
* **Check the schedule in Sprout.**
* Do not publish more than 1-2 times per day on Facebook & LinkedIn (studies show > 2 posts per day on brand pages on these platforms starts to feel spammy/index.html.md).
...
* If you’re debating between posting early and posting late, post early (i.e., 4 am Pacific/index.html.md). We have a sizable audience in Europe, so it’s best to resist posting after 4 pm PT (unless it’s a retweet, or a post that is newsworthy and published late/index.html.md)

**Content:**
* Newly published posts
* Retweet of substantive, high quality tweets, especially from team members
* Archive posts
   * If you feel the day has been light on content, feel free to check out [sample copy & assets here](https://docs.google.com/spreadsheets/d/1_RdHsIflAdLjvZKzCzMCa-xBgwZYoZgGBJr0E-6Djcs/edit?usp=sharing/index.html.md).
* Can also fill some space in the afternoon with a job posting (“jobs of the week� are in the [company call agenda](https://docs.google.com/document/d/1JiLWsTOm0yprPVIW9W-hM4iUsRxkBt_1bpm3VXV4Muc/edit/index.html.md) doc/index.html.md)
* Have fun with it! Be liberal with emojis.

**Engagement:**
* In addition to retweeting described above, please perform a search on `#gitlab` and `gitlab` a few times per day (can be within Sprout or twitter/index.html.md) and favorite positive mentions
...
* Be creative but refer back to these guidelines for the [GitLab voice](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/marketing/social-media-guidelines/#gitlab-voice/index.html.md)

**Signing off**
* If you know there is going to be a long (1+ days/index.html.md) delay between when you need to sign off and when the next person takes over (i.e., for Summit travel/index.html.md), I recommend scheduling a tweet saying something like “The team is heading to beautiful Cape Town for our xth Summit! See you on the other side :airplane:� This helps prime people for the disruption of regular content.

## Social Channels and Audience Segmentation

You can find a list of evergreen content assets their primary channel for promotion [here](https://docs.google.com/spreadsheets/d/1_RdHsIflAdLjvZKzCzMCa-xBgwZYoZgGBJr0E-6Djcs/edit?usp=sharing/index.html.md).
...
* 5 or more tweets per day, plus retweets
  * Schedule between 12 am - 5 pm PT (A large part of our audience is in EMEA, and we find an increase in organic impressions and engagement when we schedule tweets for their morning and workday/index.html.md)
...
* Consider [takeovers.](http://www.telegraph.co.uk/news/2017/07/12/work-experience-boy-takes-southern-rails-twitter-account-things/index.html.md) Would need to develop an instructions kit & think about how/who to pilot.
...
**Goals**
- Consider streaming a webcast on Facebook Live (a simple toggle switch in Zoom allows this/index.html.md) and compare the performance to YouTube live streaming
...
* Cross-post our original thought-leadership posts to Medium, linking back to blog
  - Use the [import tool](https://help.medium.com/hc/en-us/articles/214550207-Import-post/index.html.md); do not copy and paste.
...
- Find relevant handles (of speakers/moderators/hosts/index.html.md) or hashtags (if part of bigger conference for example/index.html.md), or create our own; try to include across all tweets for that event, characters permitting
- Find event-related images to attach to all tweets (event logo showing GitLab sponsorship; speaker team pic; GitLab logo; or any sharable content designed for that event/index.html.md)
- Schedule a tweet asap announcing our participation

#### Leading up to an Event, Schedule Tweets to go out:

- 1 week before event (counting down, include registration link if our event, include speaker team pic or other event branding where applicable/index.html.md)
- 1 day before event (same as above/index.html.md)
- During event referencing something in the content of the presentation if applicable/ not redundant (x2 or more depending on length of event and amount of content/index.html.md)
...
- Try to tweet them out ~1 hour or more before event (mention our location in the venue if applicable/useful/index.html.md)
...
[post or page frontmatter](../blog/#frontmatter/index.html.md), as a small summary of what the post is about.
...
[GitLab Master Plan](/2016/09/13/gitlab-master-plan/index.html.md)
- Incomplete post, with only the `description` defined:
[Y Combinator Post](/2016/09/30/gitlabs-application-for-y-combinator-winter-2015/index.html.md)
- Incomplete post, with none defined: [8.9 Release](/2016/06/22/gitlab-8-9-released/index.html.md)
- Page with both defined: [Marketing Handbook](https://github.com/daijapan/test/tree/master/marketing/index.html.md)
- Page with only `twitter_image` defined: [Team Handbook](https://github.com/daijapan/test/tree/master/index.html.md)
- Page with none defined: [Blog landing page](/blog/index.html.md)
...
[twitter-card-comp]: /imageshttps://github.com/daijapan/test/tree/master/marketing/twitter-card-complete.jpg
[twitter-card-incomp]: /imageshttps://github.com/daijapan/test/tree/master/marketing/twitter-card-incomplete.jpg
