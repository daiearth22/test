...
Examples:
- [Axway](/customers/axway/index.html.md)
- [Paessler](/customers/paessler/index.html.md)
- [Equinix](/customers/equinix/index.html.md)
...
[customers page](/customers/index.html.md). Case studies can include multiple formats, including
...
received a specific benefit and are published on GitLab's [blog](/blog/index.html.md).
...
1. Content: Submit audio recording for transcription using [Transcription Panda's](https://transcriptionpanda.com/index.html.md) `standard` (2-3 day turnaround/index.html.md) option. Use JJ's credit card (found in 1Password/index.html.md) and send her the final receipt.
4. Once transcription is returned, label issue `case study - production` and create a draft following the [case study format](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#case-study-format/index.html.md).
