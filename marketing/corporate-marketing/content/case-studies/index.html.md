...
4. Once transcription is returned, label issue `case study - production` and create a draft following the [case study format](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#case-study-format).
