...
The [GitLab blog](https://www.about.gitlab.com/blog/index.html.md) is managed by the [Managing Editor](/job-families/marketing/content-editor/index.html.md).
...
## Other related pages
- [Editorial style guide](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/#general-editorial-style-guidelines/index.html.md)
...
We follow the [GitLab Workflow](/gitlab-flow/index.html.md). At GitLab, everyone can contribute, and we encourage anyone to submit a blog post idea or write your own. Below are instructions on how to contribute to the GitLab blog.
...
- Make sure [frontmatter](https://github.com/daijapan/test/tree/master/marketing/blog#frontmatter/index.html.md) is filled out correctly
- Check all links
...
```
  ...
  ![Newsletter sign-up CTA variant A](/imageshttps://github.com/daijapan/test/tree/master/marketing/newsletter-cta-a.png/index.html.md){: .shadow}
...
<%= partial "includes/blog/content-newsletter-cta", locals: { variant: "b" } %>
  ...
  ![Newsletter sign-up CTA variant B](/imageshttps://github.com/daijapan/test/tree/master/marketing/newsletter-cta-b.png/index.html.md){: .shadow}
...
For the cover, [create an image](#artwork-and-editable-image-files/index.html.md) or choose one from any public domain resource. [Unsplash](https://unsplash.com/index.html.md) is our preferred
...
- patch releases
- performance
- [pick your brain](https://github.com/daijapan/test/tree/master/ea/#pick-your-brain-meetings/index.html.md)
- production
- releases
- remote work
- security
...
![Hero CTA preview](/imageshttps://github.com/daijapan/test/tree/master/marketing/hero-cta.png/index.html.md){:.shadow}
...
Renders:
  ...
  ![Click to tweet](/imageshttps://github.com/daijapan/test/tree/master/marketing/click-to-tweet.png/index.html.md){: .shadow}
