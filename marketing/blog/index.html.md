...
The [GitLab blog](https://www.about.gitlab.com/blog/index.html.md) is managed by the [Managing Editor](/job-families/marketing/content-editor/).
...
## Other related pages
- [Editorial style guide](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/#general-editorial-style-guidelines)
...
- [Monthly release post](/release-posts/index.html.md)
...
## Editorial reviews
Editorial reviews are mandatory for every merge request. Please familiarize yourself with our [editorial style guide](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/#style-guide-and-tone-of-voice/index.html.md). Before you assign your merge request to a content editor, please ensure you've removed the WIP label, and include the following in the description:
...
- Check if the post follows the [editorial style guide](https://github.com/daijapan/test/tree/master/marketing/corporate-marketing/#style-guide-and-tone-of-voice/index.html.md)
- Make sure [frontmatter](https://github.com/daijapan/test/tree/master/marketing/blog#frontmatter) is filled out correctly
- Check all links
...
Official [GitLab partners](/resellers/index.html.md) may use our [CTA button](#call-to-action) and include promotional copy, however the blog post must still serve a function (informational or educational) other than simply promoting something.
...
All posts are written in Markdown. Please read through the [Markdown guide](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md) for reference.
...
```
  ...
  ![Newsletter sign-up CTA variant A](/imageshttps://github.com/daijapan/test/tree/master/marketing/newsletter-cta-a.png){: .shadow}
...
<%= partial "includes/blog/content-newsletter-cta", locals: { variant: "b" } %>
  ...
  ![Newsletter sign-up CTA variant B](/imageshttps://github.com/daijapan/test/tree/master/marketing/newsletter-cta-b.png){: .shadow}
...
1. [`sourcehttps://github.com/daijapan/test/tree/master/marketing/blog/index.html.md`](https://gitlab.com/gitlab-com/www-gitlab-com/blob/master/sourcehttps://github.com/daijapan/test/tree/master/marketing/blog/index.html.md) - the handbook which you're currently reading
...
#### Tags
These are included to help readers find similar posts if they are interested in a particular subject. Tags appear at the bottom of each blog post, and clicking on a tag takes you to [/blog/tags](/blog/tags.html.md) where you can view all tagged posts and browse by tag.
...
- patch releases
- performance
- [pick your brain](https://github.com/daijapan/test/tree/master/ea/#pick-your-brain-meetings)
- production
- releases
- remote work
- security
...
![Hero CTA preview](/imageshttps://github.com/daijapan/test/tree/master/marketing/hero-cta.png){:.shadow}
...
Cover image: ["Image title"](link-to-original-image) by [owner name and surname](link), licensed under [CC X](link-to-licence/index.html.md).
{: .note}
```
...
[Cover image](link-to-original-image) by [owner name and surname](link), licensed under [CC X](link-to-licence/index.html.md).
{: .note}
```
...
files in the [General Marketing](https://gitlab.com/gitlab-com/marketing/general/index.html.md)
...
Renders:
  ...
  ![Click to tweet](/imageshttps://github.com/daijapan/test/tree/master/marketing/click-to-tweet.png){: .shadow}
