...
- For a list of release posts (both security and regular/index.html.md), check the
  category [releases](/blog/categories/releases/index.html.md).
- For a list of features per release, check the [releases](/releases/index.html.md).
...
- See also [release managers](/release-managers/index.html.md).
...
**Note:** The new design for monthly release posts was [introduced](https://gitlab.com/gitlab-com/www-gitlab-com/merge_requests/4780/index.html.md) in March 2017 with the release of [GitLab 9.0](/2017/03/22/gitlab-9-0-released/index.html.md). The new layout was [introduced](https://gitlab.com/gitlab-com/www-gitlab-com/merge_requests/5937/index.html.md) in May 2017 with the release of [GitLab 9.2](/2017/03/22/gitlab-9-2-released/index.html.md).

### Getting started

To create a new monthly release post, add two files to the [about.GitLab.com repository](https://gitlab.com/gitlab-com/www-gitlab-com/blob/master/index.html.md) (consider the release of GitLab X.Y, released in YYYY/MM/DD/index.html.md):
...
Each month a Product Manager or a Technical Writer will lead the release post, as defined in the [Release Post Scheduling page](managers/index.html.md).
...
- Making sure all the features listed in the [direction](/direction/index.html.md)
page are included in the post
- @mentioning the [release manager](/release-managers/index.html.md) to remind them
...
- You can also look at the [direction page](/direction/index.html.md) farther ahead of time to see what’s scheduled for that release.
...
- Leave comments for the PMs in the items file. Make sure to comment in the diff on the line that you are referring to so that the PM has the context and comments can be resolved appropriately.
    ...
    - See [writing about features](https://github.com/daijapan/test/tree/master/product/#writing-about-features/index.html.md) as a guideline for what feature descriptions show have.
...
They are mostly added by the Product Managers, each filling up the sections they are [accountable for](https://github.com/daijapan/test/tree/master/product/#who-to-talk-to-for-what/index.html.md).
...
[TinyPNG](https://tinypng.com/index.html.md), or other tool of your preference/index.html.md) **and** smaller than 300KB.
...
the [markdown guide](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md).
...
Always link to the [EE version of GitLab docs](https://docs.gitlab.com/ee/index.html.md) in the blog post, even if it is a CE feature.
...
Examples of previous release post intros written by PMM:
 ...
 - [GitLab 10.8 released](/2018/05/22/gitlab-10-8-released/index.html.md)
 - [GitLab 11.0 released](/2018/06/22/gitlab-11-0-released/index.html.md)
 - [GitLab 11.1 released](/2018/07/22/gitlab-11-1-released/index.html.md)

### CTA

Call-to-action buttons displayed at the end of the introduction. A CTA to the [events page](/events/index.html.md) is added by default. Add webcasts, or custom buttons to this entry whenever necessary.
...
The most relevant features of the release are included in the post by [product managers](https://github.com/daijapan/test/tree/master/product/#who-to-talk-to-for-what/index.html.md). Classify the feature according to its relevance and to where you want to place it in the blog post:
...
- `video`: when present, overrides the image and displays the linked video instead. Use the [link for embed videos](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/#videos/index.html.md). Available for primary features only. For all other blocks, add it into the description entries.
...
All `description` fields fully support [markdown](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md), the only thing you need to be worried about is respecting the indentation.

### Cover image license

According to our [Blog handbook](https://github.com/daijapan/test/tree/master/marketing/blog/#cover-image/index.html.md), it's necessary to provide the source of the cover image. Fill in the entry below to display this info at the very end of the blog post:
...
- name: Performance Improvements
  ...
  description: |
    ...
    [We're committed](https://github.com/daijapan/test/tree/master/product/#performance/index.html.md) to not only
...
To be added by the [build Product Manager](https://github.com/daijapan/test/tree/master/product/#performance/index.html.md) during the [general contributions](#general-contributions/index.html.md) stage.
...
- Frontmatter
  ...
  - Layout
- Deadlinks
- Social Sharing card (when published/index.html.md): validate with [Twitter Card Validator](https://cards-dev.twitter.com/validator/index.html.md) and [Facebook Debugger](https://developers.facebook.com/tools/debug/index.html.md)
...
For entries that support markdown, use regular [markdown Kramdown](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/index.html.md), as we use for all blog posts and webpages on about.GitLab.com.
...
[alternative text](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/#image-alt-text/index.html.md)
- {:#images-compressed} Each image should be compressed with [ImageOptim](https://imageoptim.com/index.html.md),
[TinyPNG](https://tinypng.com/index.html.md), or similar tool
...
use a unique cover image for every post, usually from [Unsplash](https://unsplash.com/index.html.md), and add
...
Every [video should wrapped into a figure tag](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/#videos/index.html.md), as in:
...
Consult the [markdown guide](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/#videos/index.html.md) for the correct markdown markup to apply to different sources (YouTube, Google Drive, HTML video/index.html.md).
...
To learn more how the templating system works, read through an overview on [Modern Static Site Generators](/2016/06/10/ssg-overview-gitlab-pages-part-2/index.html.md).
...
To update the [release post managers](managers/index.html.md), edit the data file below.
...
- **[Layout Haml file](https://gitlab.com/gitlab-com/www-gitlab-com/blob/master/sourcehttps://github.com/daijapan/test/tree/master/marketing/blog/release-posts/managers/index.html.haml/index.html.md)**: simple handbook layout that pulls the data from the YAML file above.
