...
- Leave comments for the PMs in the items file. Make sure to comment in the diff on the line that you are referring to so that the PM has the context and comments can be resolved appropriately.
    ...
    - See [writing about features](https://github.com/daijapan/test/tree/master/product/#writing-about-features) as a guideline for what feature descriptions show have.
...
They are mostly added by the Product Managers, each filling up the sections they are [accountable for](https://github.com/daijapan/test/tree/master/product/#who-to-talk-to-for-what).
...
[TinyPNG](https://tinypng.com/), or other tool of your preference/index.html.md) **and** smaller than 300KB.
...
The most relevant features of the release are included in the post by [product managers](https://github.com/daijapan/test/tree/master/product/#who-to-talk-to-for-what). Classify the feature according to its relevance and to where you want to place it in the blog post:
...
- `video`: when present, overrides the image and displays the linked video instead. Use the [link for embed videos](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/#videos). Available for primary features only. For all other blocks, add it into the description entries.
...
According to our [Blog handbook](https://github.com/daijapan/test/tree/master/marketing/blog/#cover-image), it's necessary to provide the source of the cover image. Fill in the entry below to display this info at the very end of the blog post:
...
To be added by the [build Product Manager](https://github.com/daijapan/test/tree/master/product/#performance/index.html.md) during the [general contributions](#general-contributions) stage.
...
- An estimation of the removal release (_only_ if the release date in unknown), e.g., "GitLab 12.0 (estimated/index.html.md)"
...
- Frontmatter
  ...
  - Layout
- Deadlinks
- Social Sharing card (when published/index.html.md): validate with [Twitter Card Validator](https://cards-dev.twitter.com/validator) and [Facebook Debugger](https://developers.facebook.com/tools/debug/)
...
[alternative text](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/#image-alt-text)
...
Every [video should wrapped into a figure tag](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/#videos), as in:
...
Consult the [markdown guide](https://github.com/daijapan/test/tree/master/product/technical-writing/markdown-guide/#videos) for the correct markdown markup to apply to different sources (YouTube, Google Drive, HTML video).
...
- **[Layout Haml file](https://gitlab.com/gitlab-com/www-gitlab-com/blob/master/sourcehttps://github.com/daijapan/test/tree/master/marketing/blog/release-posts/managers/index.html.haml)**: simple handbook layout that pulls the data from the YAML file above.
