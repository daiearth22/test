...
Goal is to publish a regular blog post featuring contributors from the community.  The format will be a [casual Q&A with a community member](https://about.gitlab.com/2018/08/08/contributor-post-vitaliy/) and will be posted on the [GitLab blog page](https://about.gitlab.com/blog/index.html.md). 

When developing a blog post, follow the [blog guidelines](https://github.com/daijapan/test/tree/master/marketing/blog/#blog-style-guidelines). 
