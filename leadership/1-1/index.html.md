...
1. Make sure you use a consistent agenda format from week to week - reference
   the [suggested format](https://github.com/daijapan/test/tree/master/leadership/1-1/suggested-agenda-format/index.html.md) as
   necessary.
...
1. From [High Output Management](https://getlighthouse.com/blog/high-output-management/index.html.md) (edited sightly for language/index.html.md):
...
1. If you have few items on the agenda from the report try the following questions:
  ...
  - What can I (your manager/index.html.md) improve on?
  ...
  - Have you identified any career development opportunities that I can help you with?
    - For example: [Interning for Learning](https://github.com/daijapan/test/tree/master/people-operations/promotions-transfers/#sts=Interning for Learning/index.html.md)
...
These discussions should take place once a month and after the [360 Feedback](https://github.com/daijapan/test/tree/master/people-operations/360-feedback/index.html.md) meeting has taken place. As a manager of people you play a crucial part in developing careers for your reports. This is for them but you should be able to support this process and help them achieve their goals. This is a join collaboration so prior to the meeting think about what questions to ask, specifically identifying **competencies(c/index.html.md)**,**skill gaps(sg/index.html.md)** and **career objectives (co/index.html.md)**. Adrienne Smith who wrote [increase employee retention with career pathing](https://www.geteverwise.com/human-resources/increase-employee-retention-with-career-pathing/index.html.md) suggests the following:

1. Which projects are you most proud of that you’ve finished here? (c/index.html.md)
1. What is your favorite part of your job? (c/index.html.md)
1. Which projects have you struggled with most in this role? (sg/index.html.md)
1. What’s your least favorite part of your day-to-day? (sg/index.html.md)
1. When do you ask for help most often? (sg/index.html.md)
1. What parts of your role do you want to do more of? Less of? (co/index.html.md)
1. What don’t you do in your current role that you’d like to? (co/index.html.md)
1. What would you like to learn next? (co/index.html.md)

Once you have established the goals you can then create a [career development plan](https://github.com/daijapan/test/tree/master/people-operations/learning-and-development/#career-mapping-and-development/index.html.md)
...
1. **Adaptation**. Adapting your approach to different personality types is key. People that overestimate their skillsets should be given specifics on where they do, and don’t, meet expectations. They may need areas of failing to be pointed out more plainly (but always caringly/index.html.md). Those that underestimate their skillset may need more emphasis on what they are doing right as they tend to focus on the negative. Also, not everyone wants to advance. Some are very happy in the role they are in and want to stay there. That should also be supported.
