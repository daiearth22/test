...
* When using the [Zoom plugin for Google Calendar](https://github.com/daijapan/test/tree/master/communication/#video-calls/index.html.md) you can easily get the info you need in the invite.
...
* Mark the events listed in [Google Calendar section](https://github.com/daijapan/test/tree/master/communication/#google-calendar/index.html.md) of the handbook as 'Private'
...
1. We send an email: "Thanks for being interested in GitLab. If we schedule a meeting it will follow the format on https://github.com/daijapan/test/tree/master/ceo/#pick-your-brain-meetings Are you able to submit a draft post with us within 48 hours of interview?"
1. If we receive a positive answer we schedule a 50 minute Zoom video call or [visit to our boardroom](/visiting/index.html.md) that is recorded by us, uploaded to Youtube as a private video, and shared with you.
...
Reply to emails: Thanks for wanting to chat. I propose we meet in the format proposed on https://github.com/daijapan/test/tree/master/ceo/#pick-your-brain-meetings so that other people benefit from our conversation too. If you're up for that please work with Kirsten (cc:/index.html.md) to schedule a time and location.
