...
* When using the [Zoom plugin for Google Calendar](https://github.com/daijapan/test/tree/master/communication/#video-calls) you can easily get the info you need in the invite.
...
* Mark the events listed in [Google Calendar section](https://github.com/daijapan/test/tree/master/communication/#google-calendar) of the handbook as 'Private'
...
Reply to emails: Thanks for wanting to chat. I propose we meet in the format proposed on https://github.com/daijapan/test/tree/master/ceo/#pick-your-brain-meetings so that other people benefit from our conversation too. If you're up for that please work with Kirsten (cc:) to schedule a time and location.
