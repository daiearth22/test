...
### Principles
GitLab should be **[productive](#productive), [minimal](#minimal), and [human](#human)**. We want to [*design*](https://library.gv.com/everyone-is-a-designer-get-over-it-501cc9a2f434/index.html.md) the most complete, most uncomplicated but adaptable DevOps process that allows people to focus on being the best at their job.
...
* We keep a list of improvement issues that are actively seeking contributions from the community. They are small in scope, allowing the community to contribute designs or code to the issues. You can learn more about in the [Community Contributions](https://github.com/daijapan/test/tree/master/engineering/ux/ux-department-workflow/#community-contributions) section of this handbook. You can also [view the list of issues that need UX work](https://gitlab.com/gitlab-org/gitlab-ce/issues?label_name%5B%5D=Accepting+Merge+Requests&label_name%5B%5D=UX&page=2&scope=all&state=opened/index.html.md).
...
The [GitLab design project](https://gitlab.com/gitlab-org/gitlab-design/index.html.md) is primarily used by the UX Design team to host design files and hand them off for implementation. For details, please visit the [README](https://gitlab.com/gitlab-org/gitlab-design/blob/master/README.md) for the project.
