...
Our UX department is made up of designers and researchers from all around the world. Each of them brings their own unique cultures, experiences, and strengths to GitLab. You can learn about each member of UX by visiting our [team page](/team/index.html.md) and filtering by "UX".
...
The product development timeline is described in the [engineering workflow](https://github.com/daijapan/test/tree/master/engineering/workflow/#product-development-timeline/index.html.md) section of the handbook. We will also explain it here.

At GitLab we follow a monthly release cycle, shipping on the 22nd of each month.  We plan and track these monthly releases using [milestones](https://docs.gitlab.com/ee/user/project/milestones/index.html.md).  
...
- On or around `M, 15th`: [team retrospectives](https://github.com/daijapan/test/tree/master/engineering/management/team-retrospectives/index.html.md) should happen so they can inform the [public retrospective](https://github.com/daijapan/test/tree/master/engineering/workflow/#retrospective/index.html.md)
...
![rolling-planning-visualization.png](https://github.com/daijapan/test/tree/master/engineering/ux/rolling-planning-visualization.png/index.html.md)
...
The UX Department has its kickoff as part of the [UX weekly call](https://github.com/daijapan/test/tree/master/engineering/ux#ux-weekly-call/index.html.md) directly preceding or following kickoff on the 8th of the month. Using the planning sheet as our guide, each designer walks through the issues they will be working on for that milestone. The kickoff fosters transparency and collaboration across the whole team so it is important that all UXers attend.
