...
The product development timeline is described in the [engineering workflow](https://github.com/daijapan/test/tree/master/engineering/workflow/#product-development-timeline) section of the handbook. We will also explain it here.
...
- On or around `M, 15th`: [team retrospectives](https://github.com/daijapan/test/tree/master/engineering/management/team-retrospectives/index.html.md) should happen so they can inform the [public retrospective](https://github.com/daijapan/test/tree/master/engineering/workflow/#retrospective)
...
![rolling-planning-visualization.png](https://github.com/daijapan/test/tree/master/engineering/ux/rolling-planning-visualization.png)
...
Understanding which PM is responsible for which area of the product is essential. An excellent resource for this is the [who to talk to for what](https://github.com/daijapan/test/tree/master/product/#who-to-talk-to-for-what) and [product categories](https://github.com/daijapan/test/tree/master/product/categories/index.html.md) sections of the handbook. The [product section](https://github.com/daijapan/test/tree/master/product/index.html.md) of the handbook will give you a deep dive into how product at GitLab thinks and works.
...
The UX Department has its kickoff as part of the [UX weekly call](https://github.com/daijapan/test/tree/master/engineering/ux#ux-weekly-call) directly preceding or following kickoff on the 8th of the month. Using the planning sheet as our guide, each designer walks through the issues they will be working on for that milestone. The kickoff fosters transparency and collaboration across the whole team so it is important that all UXers attend.
...
Issues that are beneficial to our users, 'nice to have(s),' that we currently do not have the capacity for or want to give priority to are part of our [Backlog (Accepting merge requests)](https://gitlab.com/gitlab-org/gitlab-ce/issues?scope=all&utf8=âœ&state=opened&milestone_title=Backlog%20(Accepting%20merge%20requests)), just as any issue we want to do but is not planned right now. We want to encourage our community to contribute at any stage of an issue we are interested in. If a backlog issue has an additional [UX ready](https://gitlab.com/gitlab-org/gitlab-ce/issues?scope=all&utf8=âœ&state=opened&milestone_title=Backlog%20(Accepting%20merge%20requests)&label_name[]=UX%20ready) label, this issue points to changes that:
