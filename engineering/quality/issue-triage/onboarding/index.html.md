...
A [regression](https://github.com/daijapan/test/tree/master/glossary/#regression) is defined as a change that results in a negative impact on the functionality of an existing feature due to recent changes, i.e. the latest release.
