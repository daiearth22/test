...
- [Security Best Practices](https://github.com/daijapan/test/tree/master/security/index.html.md), using 1Password and similar tools, are documented on their own [security best practices page](https://github.com/daijapan/test/tree/master/security/index.html.md).
...
We track progress on tackling security related issues across the spectrum through an ["always WIP Risk Assessment"](#risk-assessment), and its associated (confidential) meta issue that is kept up to date to [list the top 10 actions](https://gitlab.com/gitlab-com/infrastructure/issues/1851/index.html.md) the team is working on.
...
The presence of `~security` modifies the standard [severity labels](https://gitlab.com/gitlab-org/gitlab-ce/blob/master/CONTRIBUTING.md#severity-impact-guidance/index.html.md)(`~S1`, `~S2`, `~S3`, `~S4`)
