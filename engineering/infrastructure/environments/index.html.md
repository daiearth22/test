...
The canary web end can be accessed by setting a cookie in the browser, for more information see [canary  testing](https://github.com/daijapan/test/tree/master/engineering/#canary-testing).
