...
- [Production onboarding](https://github.com/daijapan/test/tree/master/engineering/infrastructure/production-onboarding/index.html.md)
- [GitLab.com architecture](https://github.com/daijapan/test/tree/master/engineering/infrastructure/production-architecture/index.html.md)
- [GitLab.com environments](https://github.com/daijapan/test/tree/master/engineering/infrastructure/environments/index.html.md)
...
excellence every day by living and breathing [**GitLab's values**](https://github.com/daijapan/test/tree/master/values/index.html.md) as our guiding operating
principles in every decision we make and every action we take.

## Blueprint and OKRs

The [**Infrastructure Blueprint**]( blueprint/index.html.md) outlines our overall priorities and focus on a quarterly basis.
The blueprint drives Infrastructure's OKRs, which quality and quantify the objectives and key results.

## Design

[**Design**](design/index.html.md) plays a significant role in how we produce technical solutions to meet the challenges we face
...
* [**incident management**](incident-management/index.html.md)
