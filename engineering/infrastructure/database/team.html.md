...
* Performance labels "P1-4" and severity labels "S1-4" for estimating the priority of an issue. See [Availability and Performance Priority Labels](https://github.com/daijapan/test/tree/master/engineering/performance/#performance-labels) and [CONTRIBUTING.md](https://gitlab.com/gitlab-org/gitlab-ce/blob/master/CONTRIBUTING.md#bug-priority-labels) for more information. In short: P1 is the most important, P4 the least.
