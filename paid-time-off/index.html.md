...
If you are taking Parental Leave, please see our [Parental Leave Policy](https://github.com/daijapan/test/tree/master/benefits/#parental-leave/index.html.md).
...
1. Working hours are flexible, you are invited to the [company call](https://github.com/daijapan/test/tree/master/communication/#company-call/index.html.md) if you are available, but it isn't mandatory and you shouldn't attend if it is during your time off.
1. You don't need to worry about taking time off to go to the gym, [take a nap](https://m.signalvnoise.com/sleep-deprivation-is-not-a-badge-of-honor-f24fbff47a75/index.html.md), go grocery shopping, do household chores, help someone, take care of a loved one, etc. If you have urgent tasks, but something comes up or takes longer than expected, just ensure the rest of the team **knows** and someone can pick up the tasks (assuming you're able to communicate/index.html.md).
1. GitLab encourages team members to volunteer within their community to take care of others.
1. GitLab also encourages you to use your leave for Jury Duty, bereavement leave, or to vote. You are not expected to work during this time off, but we recommend using the [Communication Guidelines](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/paid-time-off/#communicating-your-time-off/index.html.md) when these situations arise.
1. We encourage all team members to take their country of residence's official holidays off. Using [Time and Date](https://www.timeanddate.com/holidays/index.html.md), you can see which holidays are considered official by selecting your country, clicking "Change Holidays", and choosing "Official Holidays".
...
1.  Update your own calendar using Google's ["out of office"](https://www.theverge.com/2018/6/27/17510656/google-calendar-out-of-office-option/index.html.md) feature and include the dates you plan to be away in your automated response. Note that this feature will automatically decline any meeting invitations during the time frame you select.
1. Update GitLab.com. By going into your GitLab.com profile and selecting Edit. You can update your status with your out of office dates, if you will be out of the office for more than 48 hours. For Example: 'back on 2018-06-28'. Don't forget to change it back upon your return. Be aware that this information is publicly accessible.
...
1. You should also adjust your [status in Slack](https://github.com/daijapan/test/tree/master/tools-and-tips/#slack-status/index.html.md). Please use the following syntax which uses the [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601/index.html.md) date notation in order to avoid confusion: `OOO from YYYY-MM-DD to YYYY-MM-DD, please contact XXX for assistance`.
  * Optionally, if you partake in [Donut coffee chat pairings](/culture/remote-only/#coffee-break-calls/index.html.md) you can temporarily “snooze� them by opening a direct message with Donut and typing `help` to indicate which weeks you won't be able to participate. Pairings will automatically resume when you’re back.
...
1. Please see the [On-Call](https://github.com/daijapan/test/tree/master/on-call/index.html.md) page for information on how to handle scheduled leave for someone from the On-Call team.
...
for sustained periods of time. If you feel that you or someone on your team may be experiencing [burnout](http://www.mayoclinic.org/healthy-lifestyle/adult-health/in-depth/burnout/art-20046642/index.html.md), be sure to address it right away.
...
Don't just tell people to [take a break](https://medium.com/@zenpeacekeeper/take-a-break-f877907877bc/index.html.md),
but help them arrange things so they **can** take a break. Ask why they feel they can't take a break
(there are almost certainly real, concrete reasons/index.html.md) and then ask permission to get busy putting things in place
...
Other [tips to avoid burnout](http://www.mayoclinic.org/healthy-lifestyle/adult-health/in-depth/burnout/art-20046642?pg=2/index.html.md) include:
* Assess and pursue your interests, skills and passions.
* Take breaks during the day to eat healthy food and stretch your legs. The [Timeout app](http://dejal.com/timeout/index.html.md) can help with that.
* Make time each day to increase blood and oxygen circulation which improves brain activity and functionality.
* Get plenty of restful sleep.
* Meditate to take your mind away from work. [Headspace](https://www.headspace.com/science/index.html.md) and [Calm](https://www.calm.com/meditate/index.html.md) are good tools for creating meditation habits.
...
is an option for you, schedule a coffee call with [Marin](slack://user?team=T02592416&id=U025925R0/index.html.md).
...
1. GitLab LTD (UK Employees/index.html.md)
...
1. GitLab BV (Netherlands Employees/index.html.md)
...
1. GitLab BV (Belgium Employees/index.html.md)
...
1. GitLab INC (US Employees/index.html.md)
    * The U.S. [Fair Labor Standards Act (FLSA/index.html.md)](https://www.dol.gov/general/topic/workhours/vacation_leave/index.html.md) does not require payment for time not worked, such as vacations, sick leave or federal or other holidays.
1. GitLab Inc. (China/index.html.md)
...
1. Each June, People Ops will need to review the BV (Netherlands/index.html.md) Accrual for all employees and remove any carry over from the previous calendar year that was not used.
