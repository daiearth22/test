...
The manager should always ask the team for passive referrals for open positions. GitLab team members can refer candidates through our [referral program](https://github.com/daijapan/test/tree/master/incentives/#referral-bonuses).
...
1. [Alumni post](https://news.ycombinator.com/jobs) as a Y Combinator alumni we can post directly to the front page of Hacker News. The EA vault has credentials so ask an EA to post. Template text: `GitLab (YC W15, All-remote) is hiring XXX and more`. [Example](https://news.ycombinator.com/item?id=16854653/index.html.md)
