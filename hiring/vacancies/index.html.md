...
For a listing of open vacancies, please see the [vacancies section on the Jobs page](/jobs#vacancies/index.html.md). Vacancies are maintained in Lever based on our [roles](https://github.com/daijapan/test/tree/master/hiring/job-families/index.html.md). A vacancy is a temporarily open position, a position description is a permanent description that also applies to existing people with that title. Don't use vacancy and position description interchangeably. The relevant parts of a position description are copy-pasted to Lever to open a vacancy.
...
1. Review the position description in the `/roles` folder and update, if needed, by making a merge request. If there is no position description, follow the steps to [create a new role](https://github.com/daijapan/test/tree/master/hiring/job-families/#new-role-creation/index.html.md), then continue. The recruiters will use the relevant elements from this position description to open the role in Lever.
  * The position description should include:
    * Responsibilities
    * Specialty (e.g. Gitaly, Backend/index.html.md)
    * Level
    * Location (e.g. Anywhere, EMEA, Americas/index.html.md)
    * Requirements
    * Hiring Process, also update the internal [hiring process repo](https://gitlab.com/gitlab-com/people-ops/hiring-processes/index.html.md)

1. Ensure the proper approvals are in place to hire for the role.
  * The role must be listed on the "Hiring Forecast" (found on the Google Drive/index.html.md).
...
1. To open a vacancy, please go to the [People Ops Vacancy project](https://gitlab.com/gitlab-com/people-ops/vacancy/issues/index.html.md)
and create a new issue. Next to title where it says "Choose a template", select the [vacancy](https://gitlab.com/gitlab-com/people-ops/vacancy/blob/master/.gitlab/issue_templates/vacancy.md/index.html.md) template. Follow the directions that populate in the issue.
1. Once the issue is complete, People Ops will [open the vacancy in Lever](https://github.com/daijapan/test/tree/master/hiring/vacancies/#posting-the-role-in-lever/index.html.md).
...
1. Under `Lists` create a new lists titled "Responsibilities" and "Requirements"
  ...
  * Ensure the language and structure is gender neutral using this [gender decoder](http://gender-decoder.katmatfield.com/index.html.md). Make necessary edits to the vacancy description, and create a merge request to update the position description.
...
The manager should always ask the team for passive referrals for open positions. GitLab team members can refer candidates through our [referral program](https://github.com/daijapan/test/tree/master/incentives/#referral-bonuses/index.html.md).
...
1. [Alumni post](https://news.ycombinator.com/jobs/index.html.md) as a Y Combinator alumni we can post directly to the front page of Hacker News. The EA vault has credentials so ask an EA to post. Template text: `GitLab (YC W15, All-remote/index.html.md) is hiring XXX and more`. [Example](https://news.ycombinator.com/item?id=16854653/index.html.md)
1. [LinkedIn](https://www.linkedin.com/index.html.md) (Able to post 3 vacancies simultaneously, please mention to employment team if you want your role listed here/index.html.md)
1. [StackOverflow](http://stackoverflow.com/jobs/index.html.md) (Able to post 3 vacancies simultaneously, please mention to employment team if you want your role listed here/index.html.md)
1. [TechLadies](https://www.hiretechladies.com/index.html.md) (Able to post 4 roles simultaneously, please mention to employment team if you want your role listed here; at this time we are not posting engineering roles to TechLadies/index.html.md)
1. [PowerToFly](https://powertofly.com/index.html.md) (All current vacancies are updated biweekly/index.html.md)
1. [RemoteBase](https://remotebase.io/index.html.md) (Free; position descriptions are synced directly to our respective position description sites/index.html.md)
1. [WeWorkRemotely](https://weworkremotely.com/index.html.md) ($200 for 30 days, per position, used infrequently/index.html.md)
1. [RemoteOK](https://remoteok.io/index.html.md) ($200 for 90 days, per position, used infrequently/index.html.md)
1. [Indeed Prime](http://www.indeed.com/index.html.md) (Primarily used for non-engineering roles/index.html.md)
1. [Ruby Weekly](https://rubyweekly.com/index.html.md) ($199 per slot per newsletter, for engineering roles/index.html.md)

When using vacancy links to spread the word about our current vacancies, in order to keep data accurate, we can edit the link to include the specific source of different job boards, etc. At the end of the Lever vacancy link, add `?lever-origin=applied&lever-source%5B%5D=JOBBOARDNAME` and replace `JOBBOARDNAME` with the appropriate source. If you wanted to share the Developer vacancy on LinkedIn, for example, the correct link to use would be `https://jobs.lever.co/gitlab/5899df3c-4690-4c3a-a77d-1fe281a26d8a?lever-origin=applied&lever-source%5B%5D=linkedin`. When a candidate applies from this special link, it will automatically assign the source of the candidate as what is entered. For more information on this, please [see the Lever help article](https://help.lever.co/hc/en-us/articles/205325929-How-do-I-track-sources-create-custom-URLs-for-posting-to-job-boards-/index.html.md).
...
1. Ask a Lever admin (People Ops/index.html.md) to close the position in Lever.

If the position was posted on any job site (i.e. Stack Overflow, PowerToFly/index.html.md) the employment team will email the partner or remove the position from that site.
