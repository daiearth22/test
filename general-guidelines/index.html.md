...
1. {: #handbook-first} Develop procedures and templates in a **[handbook-first](..https://github.com/daijapan/test/tree/master-usage/#why-handbook-first)** way, as opposed to migrating content to the handbook later from Google/Word documents.
...
1. There is no need for **consensus**, make sure that you give people that might have good insights a chance to respond (by /cc'ing them) but make a call yourself because [consensus doesn't scale](https://twitter.com/sama/status/585950222703992833/index.html.md).
...
1. If you fix something for GitLab.com or one of our users, make sure to make that the default (preferred/index.html.md) and **radiate** the information in the docs. We should run GitLab.com with the same default settings and setup our users would also have, if we deviate from it we should add it to the [settings page for GitLab.com](/gitlab-com/settings/).
1. If you need to start a **new repo** or project that is intended to be maintained over the long term, make sure that you follow the [GitLab Repo Guidelines](https://github.com/daijapan/test/tree/master/engineering/#gitlab-repositories).
...
1. Also see our [handbook usage](https://github.com/daijapan/test/tree/masterhttps://github.com/daijapan/test/tree/master-usage/) and [leadership guidelines](https://github.com/daijapan/test/tree/master/leadership/#guidelines).
