...
A lot of tools we use are described in the rest of the handbook (GitLab, [Google Docs](https://github.com/daijapan/test/tree/master/communication/#google-docs),
[1Password](https://github.com/daijapan/test/tree/master/security/index.html.md), etc.).
...
![Change theme in Google Slides](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-slides-change-theme.png)
...
Please note that it only works for Linux distributions which use [ALSA](http://alsa-project.org) for sounds (most popular Linux distributions use ALSA). All you need to do is go to your desktop environment's _Keyboard Settings_ and create a custom shortcut with the command `amixer set Capture toggle` and assign a key combination of your choice (e.g. `Pause Break` key). Once this is done, you can mute/unmute your mic using the assigned keyboard shortcut while you're in any application. Refer to this original answer on [Askubuntu](http://askubuntu.com/a/13364/12242/index.html.md) to learn more.
...
See the [Engineering handbook](https://github.com/daijapan/test/tree/master/engineering/#resources) for a listing of cloud
...
![Google Calendar - Guests can modify events setting](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-calendar-guestsmodifyevent.png)
...
Computers with older CPUs (pre-2016/Skylake) may be missing hardware acceleration for [VP9](https://en.wikipedia.org/wiki/VP9#Hardware_encoding.2Fdecoding_support/index.html.md).
...
[One Tab (Free/index.html.md)](https://www.one-tab.com/) tames tabs into a list which can be sorted and exported.

## Quitter

[Quitter (Free/index.html.md)](https://marco.org/apps) will switch off apps for you after some period of inactivity. Consider using this to hide Slack after a while to reduce your urge to check new messages all the time.

## TripMode

[TripMode ($7.99/index.html.md)](https://www.tripmode.ch/) lets you control which apps can use the internet. Especially useful when you're working on a cellular/metered connection.
...
[Bear (Free/index.html.md)](https://www.bear-writer.com/) is a clean writing tool for notes and long-form writing. [Ulysses $5/month](https://ulyssesapp.com/) is also a great choice.

## Loom

[Loom (Free/index.html.md)](https://www.useloom.com/) is a handy Chrome plugin tool for video walkthroughs. Nice tool for demo recordings and internal/external documentation.
...
- On the middle of the page, look for a search bar and paste the URL you'd like to analyze (without `https://`) and click on the magnifier button to search:
    ...
    ![Google Analytics - find pageviews](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-analytics-find-pageviews.png)
...
including pageviews, unique pageviews, and other data:
    ...
    ![Google Analytics - see pageviews](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-analytics-pageviews.png)
...
- Click on one of the website links to look at the data for a page of your choice
    ...
    ![Google Analytics - find referrals](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-analytics-find-referrals.png)
...
- GA will output the referrals, including **Previous Page Path** and **Next Page Path**:
    ...
    ![Google Analytics - see referrals](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-analytics-referrals.png)
...
If you install [MobileDay (Free/index.html.md)](https://mobileday.com/) on your phone and give it access to your Google Calendar it can dial into conference calls for you. It is very good at detecting the number and password from the calendar invite.

## Keeping You Awake

[Keeping You Awake (Free & Open Source/index.html.md)](https://github.com/newmarcel/KeepingYouAwake) is a macOS utility application that can prevent your Mac from entering sleep mode for a predefined duration or as long as it is activated.
...
- ‚ö†∏ **CRITICAL** ‚ö†∏ Update the first one (`mary` to `mary-1`). Immediately, click
