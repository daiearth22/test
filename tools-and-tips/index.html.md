...
A lot of tools we use are described in the rest of the handbook (GitLab, [Google Docs](https://github.com/daijapan/test/tree/master/communication/#google-docs/index.html.md),
[1Password](https://github.com/daijapan/test/tree/master/security/index.html.md), etc./index.html.md).
...
![Change theme in Google Slides](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-slides-change-theme.png/index.html.md)
...
[Calendly](https://calendly.com/index.html.md) connects to your Google calendar so people can book a time with you without having a Google Account.

1. Set up a [Calendly](https://calendly.com/index.html.md) account.
...
1. Update your availability on [Calendy Event Types](https://calendly.com/event_types/index.html.md).
...
Setting the topic of the meeting is important, otherwise all meetings will be recorded with a generic name. Once recording is complete, your videos will not appear in the ‚ÄúRecordings‚Ä section of your Zoom account. Your recordings will automatically be saved to a folder on Google Drive under "GitLab Videos".
...
[firejail](https://firejail.wordpress.com/index.html.md).
...
[$4.99 tool for OS X](http://mizage.com/shush/index.html.md) that lets you set a hotkey (e.g. `fn`/index.html.md) to mute your microphone ("push-to-talk" or "push-to-mute"/index.html.md).
...
If you use Linux (e.g. [Arch](https://www.archlinux.org/index.html.md), [Ubuntu](https://www.ubuntu.com/index.html.md) or [Fedora](https://getfedora.org/index.html.md)/index.html.md) you can create a system-wide keyboard shortcut to mute/unmute your mic.
...
See the [Engineering handbook](https://github.com/daijapan/test/tree/master/engineering/#resources/index.html.md) for a listing of cloud
...
![Google Calendar - Guests can modify events setting](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-calendar-guestsmodifyevent.png/index.html.md)
...
The GitLab Availability Calendar has been deprecated to allow for GitLab to scale effectively.  We have new created [tools and tips for managing your time off](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/paid-time-off/index.html.md)
...
Having said that, there is content which doesn‚Äôt make sense to be created on the website directly (eg. large collections of data in tables, spreadsheets for calculations, etc/index.html.md) or for which Google Drive storage makes sense. For these, when creating or storing files in Google Drive, the webhttps://github.com/daijapan/test/tree/master should have a link to this content and effectively be the index for finding things of relevance that are stored in the Google drive.
...
Link your GitLab email address to an easily recognizable photo of yourself on [Gravatar](https://en.gravatar.com/index.html.md). It is company policy to use a photo, and not an avatar, a stock photo, or something with sunglasses for any of your GitLab accounts, as we have a lot of GitLabbers and our brains are comfortable with recognizing people; let's use them.

## Appear.in

[Appear.in](https://appear.in/index.html.md) allows you to instantly create a free video chat room for up to 8 participants with no login and no installation. It also offers a free reliable mobile video conference app.

## One Tab

[One Tab (Free/index.html.md)](https://www.one-tab.com/index.html.md) tames tabs into a list which can be sorted and exported.
...
[TripMode ($7.99/index.html.md)](https://www.tripmode.ch/index.html.md) lets you control which apps can use the internet. Especially useful when you're working on a cellular/metered connection.

## ShareX

[ShareX (Free / Windows only/index.html.md)](https://getsharex.com/index.html.md) is the ultimate screen capture toolbox for Windows, which includes many different options to record your screen and automate your workflow with automatic uploading, resizing and much more.

## Teampaper Snap

[Teampaper Snap (Free / Mac only/index.html.md)](http://teampaper.me/snap/index.html.md) is the ultimate screen capture tool for Mac to voice your thoughts on anything you can see on a screen.

## Clocker

[Clocker (Free / macOS Only/index.html.md)](https://abhishekbanthia.com/clocker/index.html.md) adds a clean and distraction free world clock to your menu bar so you can check on your fellow teammates across different timezones.
...
[Bear (Free/index.html.md)](https://www.bear-writer.com/index.html.md) is a clean writing tool for notes and long-form writing. [Ulysses $5/month](https://ulyssesapp.com/index.html.md) is also a great choice.

## Loom

[Loom (Free/index.html.md)](https://www.useloom.com/index.html.md) is a handy Chrome plugin tool for video walkthroughs. Nice tool for demo recordings and internal/external documentation.

## WorkFrom
[WorkFrom](https://workfrom.co/index.html.md) is a crowd-sourced resource of coffee shops and other such places that are remote-work friendly.

## Google Analytics

[Google Analytics (GA/index.html.md)](https://analytics.google.com/index.html.md) is an essential tool for making
data-driven decisions. It receives data from both about.gitlab.com and docs.gitlab.com websites.
Read through the [Online Marketing Handbook](../marketing/marketing-sales-development/online-marketing/ga-training/index.html.md)
...
- Open [GA](https://analytics.google.com/analytics/web/index.html.md), and expand **Behavior** on the sidebar
...
- On the middle of the page, look for a search bar and paste the URL you'd like to analyze (without `https://`/index.html.md) and click on the magnifier button to search:
    ...
    ![Google Analytics - find pageviews](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-analytics-find-pageviews.png/index.html.md)
...
including pageviews, unique pageviews, and other data:
    ...
    ![Google Analytics - see pageviews](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-analytics-pageviews.png/index.html.md)
...
- Click on one of the website links to look at the data for a page of your choice
    ...
    ![Google Analytics - find referrals](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-analytics-find-referrals.png/index.html.md)
...
- GA will output the referrals, including **Previous Page Path** and **Next Page Path**:
    ...
    ![Google Analytics - see referrals](/imageshttps://github.com/daijapan/test/tree/master/tools-and-tips/google-analytics-referrals.png/index.html.md)
...
[Simplenote](https://simplenote.com/index.html.md) is a free, open source note taking app which is cross platform, and syncs across all devices.

## Spectacle App

[Spectacle](https://www.spectacleapp.com/index.html.md) is a free, open source windows resizing and arrangement tool for Macs and is amazing for productivity -- particularly if you use multiple displays. Once you use this you'll never go back! Consider donating if you love it.

## MobileDay

If you install [MobileDay (Free/index.html.md)](https://mobileday.com/index.html.md) on your phone and give it access to your Google Calendar it can dial into conference calls for you. It is very good at detecting the number and password from the calendar invite.
...
[according to the handbook](https://github.com/daijapan/test/tree/master/support/workflows/services/support_workflows/dormant_username_policy.html/index.html.md).
...
check the [handbook guidelines for dormant usernames](https://github.com/daijapan/test/tree/master/support/workflows/services/support_workflows/dormant_username_policy.html/index.html.md).
...
and add a new email. ‚≠êÔ∏ **Trick** ‚≠êÔ∏ If your email at GitLab is `mary@gitlab.com`,
...
your emails sent to this alias will end up in your GitLab email account. ü
...
- ‚ö†∏ **CRITICAL** ‚ö†∏ Update the first one (`mary` to `mary-1`/index.html.md). Immediately, click
...
and on the [Marketing Handbook](https://gitlab.com/gitlab-com/www-gitlab-com/blob/master/sourcehttps://github.com/daijapan/test/tree/master/marketing/index.html.md),
in case you're a Marketing Team member.

## How to create gifs

We have a [dedicated section](https://github.com/daijapan/test/tree/master/product/making-gifs/index.html.md) for that in the handbook.
...
`find sourcehttps://github.com/daijapan/test/tree/master -type f | xargs wc -w`
...
[¬£19 tool for OS X](https://www.alfredapp.com/index.html.md) is an application launcher on steroids.
With the (paid/index.html.md) [Powerpack](https://www.alfredapp.com/powerpack/buy/index.html.md), it's the best companion for developers, enabling automation and also a fantastic clipboard history.
This feature is nicely integrated with many tools, and for example will forget passwords copied from 1password after they have been pasted. Using either the free or paid version you can also [create custom web searches](https://www.alfredapp.com/help/features/web-search/custom-searches/index.html.md) that will allow you to quickly search GitLab documentation and the handbook.
...
- https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/#stq={query}&stp=1
...
**Flash**: Due to security flaws, we strongly recommend _not_ using Adobe Flash. Certainly do not install it on your local machine. But even the Google Chrome plugin that let's you see embedded Flash content in websites can pose a security hazard. If you have not already, go to your [Chrome Flash Settings](chrome://settings/content/flash/index.html.md) and disable Flash. For further context, note that [Google Chrome is removing Flash support soon](https://nakedsecurity.sophos.com/2016/05/18/yet-more-bad-news-for-flash-as-google-chrome-says-goodbye-sort-of/index.html.md), and while the [plugin is better than a local install of Flash](http://security.stackexchange.com/questions/98117/should-flash-be-disabled-or-are-sandboxes-secure-enough/index.html.md), it still leaves vulnerabilities for [zero-day attacks](http://www.pctools.com/security-news/zero-day-vulnerability/index.html.md).

## GitLabber's Setups

For engineers interested in using Linux, please see our [linux tools page](https://github.com/daijapan/test/tree/master/tools-and-tips/linux-tools/index.html.md).
