...
NOTE: Our contractor agreements and employment contracts are all on the [Contracts](https://github.com/daijapan/test/tree/master/contracts/index.html.md) page.

## Entity Specific Benefits
- [GitLab BV (Netherlands/index.html.md)](https://github.com/daijapan/test/tree/master/benefits/bv-benefits-netherlands/index.html.md)
- [GitLab BV (Belgium/index.html.md)](https://github.com/daijapan/test/tree/master/benefits/bv-benefits-belgium/index.html.md)
- [GitLab Lyra (India/index.html.md)](https://github.com/daijapan/test/tree/master/benefits/lyra-benefits-india/index.html.md)
- [GitLab Inc (US/index.html.md)](https://github.com/daijapan/test/tree/master/benefits/inc-benefits-us/index.html.md)
- [GitLab Inc (China/index.html.md)](https://github.com/daijapan/test/tree/master/benefits/inc-benefits-china/index.html.md)
- [GitLab LTD (UK/index.html.md)](https://github.com/daijapan/test/tree/master/benefits/ltd-benefits-uk/index.html.md)
- [GitLab GmbH (Germany/index.html.md)](https://github.com/daijapan/test/tree/master/benefits/gmbh-benefits-germany/index.html.md)
...
* **Results**
  ...
  - Transform â€œstatutoryâ€ to â€œcompetitive.â€
...
* **Efficiency**
  - Use the GitLab Inc (US/index.html.md) benefits as a starting point, and try to stay as consistent as possible within the US baseline.
...
* **Iteration**
  - Regularly review current benefits (bi-annually/index.html.md) and propose changes.
...
1. GitLab will pay for the items listed under [spending company money](https://github.com/daijapan/test/tree/master/spending-company-money/index.html.md).
1. [Stock options](https://github.com/daijapan/test/tree/master/stock-options/index.html.md) are offered to most GitLabbers.
1.  Deceased team member:
    In the unfortunate event that a GitLab team member passes away, GitLab will
    provide a [$20,000](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md) lump sum to anyone of their choosing. This can be a spouse,
    partner, family member, friend, or charity.
      * For US based employees of GitLab Inc., this benefit is replaced by the
        [Basic Life Insurance](https://github.com/daijapan/test/tree/master/benefits/inc-benefits-us/#basic-life-insurance-and-add/index.html.md) that is offered through TriNet.
      * For all other GitLabbers, the following conditions apply:
         ...
         * The team member must have indicated in writing to whom the money
           should be transferred. To do this you must complete this [expression of wishes](https://docs.google.com/document/d/1bBX6Mn5JhYuQpCXgM4mkx1BbTit59l0hD2WQiY7Or9E/edit?usp=sharing/index.html.md) form, email to People Ops, who will then file in BambooHR.
         * For part-time GitLabbers, the lump sum is calculated pro-rata, so
           ...
           the lump sum would be [$10,000](https://github.com/daijapan/test/tree/master/people-operations/global-compensation/#exchange-rates/index.html.md).
1. [Paid time off policy](https://github.com/daijapan/test/tree/master/paid-time-off/index.html.md)
1. [Tuition Reimbursement](https://github.com/daijapan/test/tree/master/people-operations/code-of-conduct/#tuition-reimbursement/index.html.md)
1. [GitLab Summit](/culture/summits/index.html.md)
   * Every nine months or so GitLabbers gather at an exciting new location to [stay connected](/2016/12/05/how-we-stay-connected-as-a-remote-company/index.html.md), at what we like to call a GitLab Summit. It is important to spend time face to face to get to know your team and, if possible, meet everyone who has also bought into the company vision. There are fun activities planned by our GitLab Summit Experts, work time, and presentations from different functional groups to make this an experience that you are unlikely to forget! Attendance is optional, but encouraged. For more information and compilations of our past summits check out our [summits page](/culture/summits/index.html.md).
1. [Business Travel Accident Policy](https://drive.google.com/a/gitlab.com/file/d/0B4eFM43gu7VPVl9rYW4tXzIyeUlMR0hidWIzNk1sZjJyLUhB/view?usp=sharing/index.html.md)
   ...
   * For any assistance with claims or questions, please contact the [People Operations Analyst](/team/#brittany_rohde/index.html.md).
...
1. [Immigration](https://github.com/daijapan/test/tree/master/people-operations/visas/index.html.md) Benefits for eligible team members.
1. [Incentives](https://github.com/daijapan/test/tree/master/incentives/index.html.md) such as
   - [Sales Target Dinner Evangelism Reward](https://github.com/daijapan/test/tree/master/incentives/#sales-target-dinner/index.html.md)
   - [Discretionary Bonuses](https://github.com/daijapan/test/tree/master/incentives/#discretionary-bonuses/index.html.md)
   - [Referral Bonuses](https://github.com/daijapan/test/tree/master/incentives/#referral-bonuses/index.html.md)
   - [Visiting Grant](https://github.com/daijapan/test/tree/master/incentives/#visiting-grant/index.html.md)

## Parental Leave

Anyone (regardless of gender/index.html.md) at GitLab who becomes a parent through childbirth or adoption is able to take fully paid parental leave. GitLabbers will be encouraged to decide for themselves the appropriate amount of time to take and how to take it. We will offer everyone who has been at GitLab for a year up to 12 weeks of 100% paid time off during the first year of parenthood. We encourage parents to take 8-12 weeks.
...
1. To initiate your parental leave, please send an email to People Ops and your manager at least thirty days before your leave will begin, and also take a look at the process for application based on your employment company Country Specific Leave Requirements, which are subject to change as legal requirements change:
  * [GitLab Inc. United States Leave Policy](https://github.com/daijapan/test/tree/master/benefits/inc-benefits-us/#gitlab-inc-united-states-leave-policy/index.html.md)
  * [GitLab Inc. China Leave Policy](https://github.com/daijapan/test/tree/master/benefits/inc-benefits-china/#gitlab-inc-china-leave-policy/index.html.md)
  * [GitLab B.V. Netherlands Leave Policy](https://github.com/daijapan/test/tree/master/benefits/bv-benefits-netherlands/#gitlab-bv-netherlands-leave-policy/index.html.md)
  * [GitLab B.V. Belgium Leave Policy](https://github.com/daijapan/test/tree/master/benefits/bv-benefits-belgium/#gitlab-bv-belgium-leave-policy/index.html.md)
  * [GitLab B.V. India Leave Policy](https://github.com/daijapan/test/tree/master/benefits/lyra-benefits-india/#gitlab-bv-india-leave-policy/index.html.md)
  * [GitLab LTD United Kingdom Leave Policy](https://github.com/daijapan/test/tree/master/benefits/ltd-benefits-uk/#gitlab-ltd-united-kingdom-leave-policy/index.html.md)
  * [GitLab GmbH Germany Leave Policy](https://github.com/daijapan/test/tree/master/benefits/gmbh-benefits-germany/#gitlab-gmbh-germany-leave-policy/index.html.md)
...
If you need any additional leave, please refer to our [Paid Time Off Policy](https://github.com/daijapan/test/tree/master/paid-time-off/index.html.md).
