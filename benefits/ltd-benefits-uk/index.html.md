...
- Enhanced outpatient cover - overall limit to £1,000 per annum
- Therapies Cover
- Mental Health Cover
- Extra Care
- Extra Cancer Cover
...
As of January 1, 2018 GitLab will be providing and contributing into an Auto-Enrollment personal pension scheme with [Scottish Widows](http://www.scottishwidows.co.uk/retirement/retirement-explained/basics/auto-enrolment/index.html.md). GitLab is also working with [Oakley Financial](http://www.oakleyfinancial.com/index.html.md) who are able to provide help and guidance should employees have any questions about the pension scheme. An email and telephone service is available and you can find the details in the [contacts](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/benefits/ltd-benefits-uk/#contacts/index.html.md) section.
...
If an employee does not meet these criteria then they will be considered an **Entitled Worker** (earn less than £5,824 p.a/index.html.md) or a **Non-Eligible Jobholder** (earn between £5,824 and £10,000 p.a/index.html.md).
