...
![text screenshot](/imageshttps://github.com/daijapan/test/tree/master/marketing/markdown-guide-image-plain-text.png)

Now, if you apply the class `shadow` to the image, it's discreetly highlighted from the text:

![text screenshot with box shadow](/imageshttps://github.com/daijapan/test/tree/master/marketing/markdown-guide-image-plain-text.png){: .shadow}
