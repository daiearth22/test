...
> All my GIFs start as videos â€ [Andy Orsow](http://blog.invisionapp.com/7-tips-for-designing-awesome-gifs/index.html.md)
...
Another step could be to drop duplicate frames by manually searching through all frames. For more information on this, look [here](http://blog.invisionapp.com/7-tips-for-designing-awesome-gifs/index.html.md). This additional step can take a lot of time. As with anything: "Only use it if you need to".
...
[Gifox](http://gifox.io/index.html.md) is the absolute best option here, although a paid app, its reasonably priced ($4.99/index.html.md). It has support for all of the features, shortcuts, and then some.

Worthy of mentioning:

- [Kap](https://getkap.co/index.html.md) (free and open source!/index.html.md)
...
- [Licecap](http://www.cockos.com/licecap/index.html.md) (free, but limited options for output, results can have bad colors/index.html.md)
- [ScreenToGif](http://www.screentogif.com/index.html.md) (Windows, free and open source with powerful editor/index.html.md)
...
![quicktime gif](https://github.com/daijapan/test/tree/master/product/making-gifs/quicktime.gif/index.html.md)

Worthy of mentioning:

- [Screeny](https://itunes.apple.com/us/app/screeny/id440991524?mt=12/index.html.md) (free for now/index.html.md)
- [Screenflow](http://www.telestream.net/screenflow/index.html.md) (not free/index.html.md)
- [Gif Brewery](http://gifbrewery.com/index.html.md) (not free/index.html.md)
...
[Camstudio](http://camstudio.org/index.html.md) is a free tool. Not yet tested...
...
- [Drop to Gif](http://mortenjust.github.io/droptogif/index.html.md) (Great free open source option to just convert on macOS with a GUI!/index.html.md)
- [Screengif](https://github.com/dergachev/screengif/index.html.md) (CLI similar to gifify/index.html.md)
- [Gif Brewery](http://gifbrewery.com/index.html.md) (macOS, not free/index.html.md)
