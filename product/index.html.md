...
For the _what_, see [Product Direction](/direction/index.html.md).
...
* [Product Categories](https://github.com/daijapan/test/tree/master/product/categories/index.html.md)
...
* [Demo](https://github.com/daijapan/test/tree/master/marketing/product-marketing/demo/index.html.md)

## Who to talk to for what

### Who

Please see the [Product Categories](https://github.com/daijapan/test/tree/master/product/categories/index.html.md) to know which product manager handles which category.
...
issue](https://github.com/daijapan/test/tree/master/product/#how-to-submit-a-new-issue/index.html.md).
...
See our [product categories](https://github.com/daijapan/test/tree/master/product/categories/index.html.md) for how to map our product to product managers.
...
1. [Vision](/direction/product-vision/index.html.md): year
...
- First part of [Dear PMs, It's Time to Rethink Agile at Enterprise Startups](http://firstround.com/review/dear-pms-its-time-to-rethink-agile-at-enterprise-startups/index.html.md)
...
that we wanted to try in every release, and similar to our [OKRs](https://github.com/daijapan/test/tree/master/ceo/#three-levels-of-performance/index.html.md),
...
us do that. Also see [the importance of velocity](https://github.com/daijapan/test/tree/master/engineering/#the-importance-of-velocity/index.html.md)
...
a [blog post](/2017/01/04/behind-the-scenes-how-we-built-review-apps/index.html.md).

Much of our product philosophies are inspired by the [Ruby on Rails doctrine](http://rubyonrails.org/doctrine/index.html.md) of ['Rails is omakase'](http://david.heinemeierhansson.com/2012/rails-is-omakase.html/index.html.md). I highly suggest reading these.
...
![mvc.png](https://github.com/daijapan/test/tree/master/product/mvc.png/index.html.md)
...
[![xkcd.com](https://imgs.xkcd.com/comics/optimization.png/index.html.md)](https://xkcd.com/1691/index.html.md)
...
[![xkcd.com](https://imgs.xkcd.com/comics/standards.png/index.html.md)](https://xkcd.com/927/index.html.md)
...
[![xkcd.com](https://imgs.xkcd.com/comics/squirrel_plan.png/index.html.md)](https://xkcd.com/1503/index.html.md)
...
[![xkcd.com](https://imgs.xkcd.com/comics/app.png/index.html.md)](https://xkcd.com/1174/index.html.md)
...
![pipelines_empty_state.png](https://github.com/daijapan/test/tree/master/product/pipelines_empty_state.png/index.html.md)
...
![pipelines_empty_state.png](https://github.com/daijapan/test/tree/master/product/banner_customize_experience.png/index.html.md)
...
![tooltip_boards.png](https://github.com/daijapan/test/tree/master/product/tooltip_boards.png/index.html.md)

#### Single application

GitLab is a single application, rather than a set of loosely connected
components. This is a big advantage, [read why here](https://github.com/daijapan/test/tree/master/product/single-application/index.html.md).
...
Issues like security come in [different severity levels](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/engineering/security/#labels-and-confidentiality/index.html.md).
...
- Is it a top project from the [OKRs](/okrs/index.html.md)?
...
- Does it help generate revenue for us through our [paid tiers](https://github.com/daijapan/test/tree/master/product/#paid-tiers/index.html.md)? (i.e what is the impact on IACV?/index.html.md)
...
Read the handbook page relating to [performance of GitLab.com](https://github.com/daijapan/test/tree/master/engineering/performance/index.html.md), and note the Speed Index target shown there
...
- Use the [availability & performance priority labels](https://github.com/daijapan/test/tree/master/engineering/performance/#performance-labels/index.html.md)
to communicate and prioritize issues relating to performance.

Of course, you must prioritize improvements according to their impact (per the [availability & performance priority labels](https://github.com/daijapan/test/tree/master/engineering/performance/#performance-labels/index.html.md)/index.html.md).
...
You can read more about our approach in the [Secure Vision](/direction/secure/index.html.md) page.

If you are interested in advanced technical details, you can find more in the
[Secure Team engineering](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/engineering/ops-backend/secure/index.html.md) page.
...
internally and externally how the team is planning to deliver on the [product vision](https://about.gitlab.com/direction/product-vision/index.html.md).
...
proper MVC proposal is reached (see [Contents of an MVP](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/product/#content-of-an-mvp/index.html.md)
...
and vice versa. The format of the [2018 vision](https://about.gitlab.com/direction/product-vision/index.html.md)
...
next [summit](https://about.gitlab.com/culture/summits/index.html.md), as well as prior to
...
- **7th** - Code freeze for the current release goes into effect. After this
  ...
  release. Notify your manager of anything that did not make it, [if you haven't already](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/product/#shifting-commitment-mid-iteration/index.html.md).
...
- **14th** (6th working day before the 22nd/index.html.md) - All relevant items in your area have been added to the [release post draft]
  (https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/marketing/blog/release-posts/index.html.md) for the
  current release.
- **15th** - [Team retrospective](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/engineering/management/team-retrospectives/index.html.md)
...
into an [epic](https://docs.gitlab.com/ee/user/group/epics/index.html.md).
...
[Balsamiq](https://balsamiq.com/index.html.md) for its simplicity and its sketch-style approach.
...
Refer to the [Product Development Timeline](https://github.com/daijapan/test/tree/master/engineering/workflow/#product-development-timeline/index.html.md)
...
For a detailed timeline, see [the product development timeline](https://github.com/daijapan/test/tree/master/engineering/workflow/#product-development-timeline/index.html.md).
...
This way we can preserve the efficiency of [our value of iteration](https://github.com/daijapan/test/tree/master/values/#iteration/index.html.md).
...
still relevant, we can then reopen it. See https://github.com/daijapan/test/tree/master/product/#when-to-create-or-close-an-issue
...
[general handbook](https://github.com/daijapan/test/tree/master/index.html.md).
...
or shipping [complete DevOps](/2017/10/04/devops-strategy/index.html.md). We announced our
first Master Plan as part of our [Series B funding announcement](/2016/09/13/gitlab-master-plan/index.html.md),
and our second master plan with our [Series C announcement](/2017/10/09/gitlab-raises-20-million-to-complete-devops/index.html.md).
...
* turn that into a [single-source-of-truth based on issues](/direction/product-vision/index.html.md),
...
As a PM, you are [accountable](https://github.com/daijapan/test/tree/master/marketing/blog/release-posts/#general-contributions/index.html.md)
...
[release posts handbook](https://github.com/daijapan/test/tree/master/marketing/blog/release-posts/index.html.md) and its **due dates**.
Be sure to go over all the details.

Every month, a PM will take the
[leadership](https://github.com/daijapan/test/tree/master/marketing/blog/release-posts/#authorship/index.html.md)
...
- always mention the [appropriate PMM](https://github.com/daijapan/test/tree/master/product/categories/index.html.md) on epics and high level issues
...
Please see [The likely type of buyer determines what features go in what tier](https://github.com/daijapan/test/tree/master/product/pricing/#the-likely-type-of-buyer-determines-what-features-go-in-what-tier/index.html.md).
...
[pricing page in the handbook](https://github.com/daijapan/test/tree/master/product/pricing/index.html.md).
...
To avoid complexity, [GitLab.com tiers and GitLab self-managed tiers](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#tiers/index.html.md) have a 1:1 match.
...
[EE usage](https://version.gitlab.com/index.html.md): dev.gitlab.org account
...
1. DevOps lifecycle stages (stages/index.html.md), see [SDLC](/sdlc/index.html.md)
1. Product categories (categories/index.html.md), see [SDLC](/sdlc/index.html.md)
...
1. Individual features (features/index.html.md), see [Features](/features/index.html.md)
...
- [Release posts handbook](https://github.com/daijapan/test/tree/master/marketing/blog/release-posts/index.html.md)
