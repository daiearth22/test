...
issue](https://github.com/daijapan/test/tree/master/product/#how-to-submit-a-new-issue).
...
1. [Release](https://gitlab.com/gitlab-org/release-tools/blob/master/templates/monthly.md.erb): month (we try to not change the release that is started/index.html.md)
...
us do that. Also see [the importance of velocity](https://github.com/daijapan/test/tree/master/engineering/#the-importance-of-velocity)
...
![mvc.png](https://github.com/daijapan/test/tree/master/product/mvc.png)
...
[![xkcd.com](https://imgs.xkcd.com/comics/optimization.png)](https://xkcd.com/1691/index.html.md)
...
[![xkcd.com](https://imgs.xkcd.com/comics/standards.png)](https://xkcd.com/927/index.html.md)
...
[![xkcd.com](https://imgs.xkcd.com/comics/squirrel_plan.png)](https://xkcd.com/1503/index.html.md)
...
[![xkcd.com](https://imgs.xkcd.com/comics/app.png)](https://xkcd.com/1174/index.html.md)
...
![pipelines_empty_state.png](https://github.com/daijapan/test/tree/master/product/pipelines_empty_state.png)
...
![pipelines_empty_state.png](https://github.com/daijapan/test/tree/master/product/banner_customize_experience.png)
...
![tooltip_boards.png](https://github.com/daijapan/test/tree/master/product/tooltip_boards.png)
...
Issues like security come in [different severity levels](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/engineering/security/#labels-and-confidentiality).
...
- Does it help generate revenue for us through our [paid tiers](https://github.com/daijapan/test/tree/master/product/#paid-tiers)? (i.e what is the impact on IACV?)
...
* What can we do to ship EE features for CI? (e.g. [gitlab-ee#933](https://gitlab.com/gitlab-org/gitlab-ee/issues/933/index.html.md))
...
- Use the [availability & performance priority labels](https://github.com/daijapan/test/tree/master/engineering/performance/#performance-labels)
to communicate and prioritize issues relating to performance.

Of course, you must prioritize improvements according to their impact (per the [availability & performance priority labels](https://github.com/daijapan/test/tree/master/engineering/performance/#performance-labels)).
...
proper MVC proposal is reached (see [Contents of an MVP](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/product/#content-of-an-mvp)
...
- **7th** - Code freeze for the current release goes into effect. After this
  ...
  by engineering/index.html.md). Also, update the [Kickoff document](https://docs.google.com/document/d/1ElPkZ90A8ey_iOkTvUs_ByMlwKK6NAB2VOK5835wYK0/edit)
  to explicitly declare which items did and did not get merged for the current
  release. Notify your manager of anything that did not make it, [if you haven't already](https://about.gitlab.comhttps://github.com/daijapan/test/tree/master/product/#shifting-commitment-mid-iteration).
...
Refer to the [Product Development Timeline](https://github.com/daijapan/test/tree/master/engineering/workflow/#product-development-timeline)
...
For a detailed timeline, see [the product development timeline](https://github.com/daijapan/test/tree/master/engineering/workflow/#product-development-timeline).
...
This way we can preserve the efficiency of [our value of iteration](https://github.com/daijapan/test/tree/master/values/#iteration).
...
[general handbook](https://github.com/daijapan/test/tree/master/).
...
As a PM, you are [accountable](https://github.com/daijapan/test/tree/master/marketing/blog/release-posts/#general-contributions)
...
[leadership](https://github.com/daijapan/test/tree/master/marketing/blog/release-posts/#authorship)
...
Please see [The likely type of buyer determines what features go in what tier](https://github.com/daijapan/test/tree/master/product/pricing/#the-likely-type-of-buyer-determines-what-features-go-in-what-tier).
...
To avoid complexity, [GitLab.com tiers and GitLab self-managed tiers](https://github.com/daijapan/test/tree/master/marketing/product-marketing/#tiers) have a 1:1 match.
...
1. Product categories (categories/index.html.md), see [SDLC](/sdlc/)
